...
const EXERCISES = [
  ...
  // ---- Exos importés (FR) ----
  { key: "fr_adduction_hanche", name: "Adduction Hanche", icon: "⊥", primary: "fessiers", eliteRatio: 1.0, bw: false, perHand: false,
  ...
  { key: "fr_braquial_de_t_mort", name: "Braquial De T Mort", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Braquial De T Mort"), aliases: ["braquial de t mort"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_curl_biceps_poulie", name: "Curl Biceps (Poulie)", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Curl Biceps (Poulie)"), aliases: ["curl biceps (poulie)"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_curl_incline_vis_a_vis", name: "Curl Incliné Vis A Vis", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Curl Incliné Vis A Vis"), aliases: ["curl incliné vis a vis"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_curl_marteau_poulie", name: "Curl Marteau (Poulie)", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Curl Marteau (Poulie)"), aliases: ["curl marteau (poulie)"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_curl_poignet", name: "Curl Poignet", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Curl Poignet"), aliases: ["curl poignet"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_curl_poignet_haut", name: "Curl Poignet (Haut)", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Curl Poignet (Haut)"), aliases: ["curl poignet (haut)"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_curl_poignet_arriere_deb", name: "Curl Poignet Arrière Debout (Barre)", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Curl Poignet Arrière Debout (Barre)"), aliases: ["curl poignet arrière debout (barre)"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_curl_poignets_paumes_ver", name: "Curl Poignets Paumes vers le Haut Assis", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Curl Poignets Paumes vers le Haut Assis"), aliases: ["curl poignets paumes vers le haut assis"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_developper_couche_inclin", name: "Développer Couché Incliné Vis A Vis", icon: "◇", primary: "pecs", eliteRatio: 0.7, bw: false, perHand: false,
    muscles: { pecs: 1.0 }, yt: yt("Développer Couché Incliné Vis A Vis"), aliases: ["développer couché incliné vis a vis"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_developper_vis_a_vis_che", name: "Développer Vis A Vis Chess Press", icon: "◇", primary: "pecs", eliteRatio: 0.7, bw: false, perHand: false,
    muscles: { pecs: 1.0 }, yt: yt("Développer Vis A Vis Chess Press"), aliases: ["développer vis a vis chess press"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_exo_chelou_de_lo\u00efc", name: "Exo Chelou De Loïc", icon: "◳", primary: "abdos", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { abdos: 1.0 }, yt: yt("Exo Chelou De Loïc"), aliases: ["exo chelou de loïc"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_exo_miaou", name: "Exo Miaou", icon: "◳", primary: "abdos", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { abdos: 1.0 }, yt: yt("Exo Miaou"), aliases: ["exo miaou"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_exo_triceps_yoga", name: "Exo Triceps Yoga", icon: "↧", primary: "triceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { triceps: 1.0 }, yt: yt("Exo Triceps Yoga"), aliases: ["exo triceps yoga"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_extension_poignets_assis", name: "Extension Poignets Assis (Barre)", icon: "↿", primary: "biceps", eliteRatio: 0.5, bw: false, perHand: false,
    muscles: { biceps: 1.0 }, yt: yt("Extension Poignets Assis (Barre)"), aliases: ["extension poignets assis (barre)"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_tirage_corde_bras_tendus", name: "Tirage Corde Bras Tendus", icon: "═", primary: "dos", eliteRatio: 1.0, bw: false, perHand: false,
    muscles: { dos: 1.0 }, yt: yt("Tirage Corde Bras Tendus"), aliases: ["tirage corde bras tendus"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_tirage_poulie_a_genoux", name: "Tirage Poulie A Genoux", icon: "═", primary: "dos", eliteRatio: 1.0, bw: false, perHand: false,
    muscles: { dos: 1.0 }, yt: yt("Tirage Poulie A Genoux"), aliases: ["tirage poulie a genoux"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_tirage_poulie_a_genoux_e", name: "Tirage Poulie à Genoux (Élastique)", icon: "═", primary: "dos", eliteRatio: 1.0, bw: false, perHand: false,
    muscles: { dos: 1.0 }, yt: yt("Tirage Poulie à Genoux (Élastique)"), aliases: ["tirage poulie à genoux (élastique)"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_elevation_frontale_halte", name: "Élévation Frontale (Haltère)", icon: "⊥", primary: "epaules", eliteRatio: 0.3, bw: false, perHand: true,
    muscles: { epaules: 1.0 }, yt: yt("Élévation Frontale (Haltère)"), aliases: ["élévation frontale (haltère)"],
    tips: ["Exercice importé — ajuste la charge et progresse régulièrement."] },
  { key: "fr_elevation_frontale_pouli", name: "Élévation Frontale (Poulie)", icon: "⊥", primary: "epaules", eliteRatio: 0.3, bw: false, perHand: false,
...
const EXTRA_DB = [
["db_3_4_sit_up","3/4 Sit-Up","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_90_90_hamstring","90/90 Hamstring","ischios",1.5,0,1,{ischios:0.7,mollets:0.3},"body only"],
["db_ab_crunch_machine","Ab Crunch Machine","abdos",0.6,0,0,{abdos:1.0},"machine"],
["db_ab_roller","Ab Roller","abdos",0.6,0,0,{abdos:0.7,epaules:0.3},"other"],
["db_adductor","Adductor","fessiers",1.5,0,0,{fessiers:1.0},"foam roll"],
["db_adductor_groin","Adductor/Groin","fessiers",1.5,0,0,{fessiers:1.0},"autre"],
["db_advanced_kettlebell_windmill","Advanced Kettlebell Windmill","abdos",0.6,0,0,{abdos:0.7,fessiers:0.1,ischios:0.1,epaules:0.1},"kettlebells"],
["db_air_bike","Air Bike","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_all_fours_quad_stretch","All Fours Quad Stretch","quads",2.0,0,1,{quads:1.0},"body only"],
["db_alternate_hammer_curl","Alternate Hammer Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_alternate_heel_touchers","Alternate Heel Touchers","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_alternate_incline_dumbbell_curl","Alternate Incline Dumbbell Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_alternate_leg_diagonal_bound","Alternate Leg Diagonal Bound","quads",2.0,0,0,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"autre"],
["db_alternating_cable_shoulder_press","Alternating Cable Shoulder Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"cable"],
["db_alternating_deltoid_raise","Alternating Deltoid Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_alternating_floor_press","Alternating Floor Press","pecs",1.3,0,0,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"kettlebells"],
["db_alternating_hang_clean","Alternating Hang Clean","ischios",1.5,0,0,{ischios:0.7,biceps:0.1,mollets:0.05,fessiers:0.05,dos:0.05,epaules:0.05},"kettlebells"],
["db_alternating_kettlebell_press","Alternating Kettlebell Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"kettlebells"],
["db_alternating_kettlebell_row","Alternating Kettlebell Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"kettlebells"],
["db_alternating_renegade_row","Alternating Renegade Row","dos",1.3,0,0,{dos:0.7,abdos:0.07,biceps:0.07,pecs:0.07,triceps:0.07},"kettlebells"],
["db_ankle_circles","Ankle Circles","mollets",1.8,0,0,{mollets:1.0},"autre"],
["db_ankle_on_the_knee","Ankle On The Knee","fessiers",1.5,0,0,{fessiers:1.0},"autre"],
["db_anterior_tibialis_smr","Anterior Tibialis-SMR","mollets",1.8,0,0,{mollets:1.0},"other"],
["db_anti_gravity_press","Anti-Gravity Press","epaules",0.9,0,0,{epaules:0.7,dos:0.15,triceps:0.15},"barbell"],
["db_arm_circles","Arm Circles","epaules",0.9,0,0,{epaules:1.0},"autre"],
["db_arnold_dumbbell_press","Arnold Dumbbell Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_around_the_worlds","Around The Worlds","pecs",1.3,1,0,{pecs:0.7,epaules:0.3},"dumbbell"],
["db_atlas_stone_trainer","Atlas Stone Trainer","dos",1.3,0,0,{dos:0.7,biceps:0.12,fessiers:0.06,ischios:0.06,quads:0.06},"other"],
["db_atlas_stones","Atlas Stones","dos",1.3,0,0,{dos:0.7,abdos:0.03,fessiers:0.06,biceps:0.06,mollets:0.03,ischios:0.03,quads:0.03,epaules:0.03},"other"],
["db_axle_deadlift","Axle Deadlift","dos",1.3,0,0,{dos:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,quads:0.06,epaules:0.06},"other"],
["db_back_flyes_with_bands","Back Flyes - With Bands","epaules",0.9,0,0,{epaules:0.7,dos:0.15,triceps:0.15},"bands"],
["db_backward_drag","Backward Drag","quads",2.0,0,0,{quads:0.7,mollets:0.06,biceps:0.06,fessiers:0.06,ischios:0.06,dos:0.06},"other"],
["db_backward_medicine_ball_throw","Backward Medicine Ball Throw","epaules",0.9,0,0,{epaules:1.0},"medicine ball"],
["db_balance_board","Balance Board","mollets",1.8,0,0,{mollets:0.7,ischios:0.15,quads:0.15},"other"],
["db_ball_leg_curl","Ball Leg Curl","ischios",1.5,0,0,{ischios:0.7,mollets:0.15,fessiers:0.15},"exercise ball"],
["db_band_assisted_pull_up","Band Assisted Pull-Up","dos",1.3,0,0,{dos:0.7,abdos:0.15,biceps:0.15},"other"],
["db_band_good_morning","Band Good Morning","ischios",1.5,0,0,{ischios:0.7,fessiers:0.15,dos:0.15},"bands"],
["db_band_good_morning_pull_through","Band Good Morning (Pull Through)","ischios",1.5,0,0,{ischios:0.7,fessiers:0.15,dos:0.15},"bands"],
["db_band_hip_adductions","Band Hip Adductions","fessiers",1.5,0,0,{fessiers:1.0},"bands"],
["db_band_pull_apart","Band Pull Apart","epaules",0.9,0,0,{epaules:0.7,dos:0.3},"bands"],
["db_band_skull_crusher","Band Skull Crusher","triceps",0.6,0,0,{triceps:1.0},"bands"],
["db_barbell_ab_rollout","Barbell Ab Rollout","abdos",0.6,0,0,{abdos:0.7,dos:0.15,epaules:0.15},"barbell"],
["db_barbell_ab_rollout_on_knees","Barbell Ab Rollout - On Knees","abdos",0.6,0,0,{abdos:0.7,dos:0.15,epaules:0.15},"barbell"],
["db_barbell_bench_press_medium_grip","Barbell Bench Press - Medium Grip","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_barbell_curl","Barbell Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_barbell_curls_lying_against_an_inc","Barbell Curls Lying Against An Incline","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_barbell_deadlift","Barbell Deadlift","dos",1.3,0,0,{dos:0.7,mollets:0.05,biceps:0.05,fessiers:0.05,ischios:0.05,quads:0.05,epaules:0.05},"barbell"],
["db_barbell_full_squat","Barbell Full Squat","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"barbell"],
["db_barbell_glute_bridge","Barbell Glute Bridge","fessiers",1.5,0,0,{fessiers:0.7,mollets:0.15,ischios:0.15},"barbell"],
["db_barbell_guillotine_bench_press","Barbell Guillotine Bench Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_barbell_hack_squat","Barbell Hack Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,biceps:0.1,ischios:0.1},"barbell"],
["db_barbell_hip_thrust","Barbell Hip Thrust","fessiers",1.5,0,0,{fessiers:0.7,mollets:0.15,ischios:0.15},"barbell"],
["db_barbell_incline_bench_press_medium","Barbell Incline Bench Press - Medium Grip","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_barbell_incline_shoulder_raise","Barbell Incline Shoulder Raise","epaules",0.9,0,0,{epaules:0.7,pecs:0.3},"barbell"],
["db_barbell_lunge","Barbell Lunge","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_barbell_rear_delt_row","Barbell Rear Delt Row","epaules",0.9,0,0,{epaules:0.7,biceps:0.1,dos:0.2},"barbell"],
["db_barbell_rollout_from_bench","Barbell Rollout from Bench","abdos",0.6,0,0,{abdos:0.7,fessiers:0.07,ischios:0.07,dos:0.07,epaules:0.07},"barbell"],
["db_barbell_seated_calf_raise","Barbell Seated Calf Raise","mollets",1.8,0,0,{mollets:1.0},"barbell"],
["db_barbell_shoulder_press","Barbell Shoulder Press","epaules",0.9,0,0,{epaules:0.7,pecs:0.15,triceps:0.15},"barbell"],
["db_barbell_shrug","Barbell Shrug","epaules",0.9,0,0,{epaules:1.0},"barbell"],
["db_barbell_shrug_behind_the_back","Barbell Shrug Behind The Back","epaules",0.9,0,0,{epaules:0.7,biceps:0.15,dos:0.15},"barbell"],
["db_barbell_side_bend","Barbell Side Bend","abdos",0.6,0,0,{abdos:0.7,dos:0.3},"barbell"],
["db_barbell_side_split_squat","Barbell Side Split Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,ischios:0.1,dos:0.1},"barbell"],
["db_barbell_squat","Barbell Squat","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"barbell"],
["db_barbell_squat_to_a_bench","Barbell Squat To A Bench","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"barbell"],
["db_barbell_step_ups","Barbell Step Ups","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_barbell_walking_lunge","Barbell Walking Lunge","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_battling_ropes","Battling Ropes","epaules",0.9,0,0,{epaules:0.7,pecs:0.15,biceps:0.15},"other"],
["db_bear_crawl_sled_drags","Bear Crawl Sled Drags","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"other"],
["db_behind_head_chest_stretch","Behind Head Chest Stretch","pecs",1.3,0,0,{pecs:0.7,epaules:0.3},"other"],
["db_bench_dips","Bench Dips","triceps",0.6,0,1,{triceps:0.7,pecs:0.15,epaules:0.15},"body only"],
["db_bench_jump","Bench Jump","quads",2.0,0,1,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"body only"],
["db_bench_press_powerlifting","Bench Press - Powerlifting","triceps",0.6,0,0,{triceps:0.7,pecs:0.07,biceps:0.07,dos:0.07,epaules:0.07},"barbell"],
["db_bench_press_with_bands","Bench Press - With Bands","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"bands"],
["db_bench_press_with_chains","Bench Press with Chains","triceps",0.6,0,0,{triceps:0.7,pecs:0.1,dos:0.1,epaules:0.1},"barbell"],
["db_bench_sprint","Bench Sprint","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"other"],
["db_bent_arm_barbell_pullover","Bent-Arm Barbell Pullover","dos",1.3,0,0,{dos:0.7,pecs:0.1,epaules:0.1,triceps:0.1},"barbell"],
["db_bent_arm_dumbbell_pullover","Bent-Arm Dumbbell Pullover","pecs",1.3,1,0,{pecs:0.7,dos:0.1,epaules:0.1,triceps:0.1},"dumbbell"],
["db_bent_knee_hip_raise","Bent-Knee Hip Raise","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_bent_over_barbell_row","Bent Over Barbell Row","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"barbell"],
["db_bent_over_dumbbell_rear_delt_raise","Bent Over Dumbbell Rear Delt Raise With Head On Bench","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_bent_over_low_pulley_side_lateral","Bent Over Low-Pulley Side Lateral","epaules",0.9,0,0,{epaules:0.7,dos:0.3},"cable"],
["db_bent_over_one_arm_long_bar_row","Bent Over One-Arm Long Bar Row","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"barbell"],
["db_bent_over_two_arm_long_bar_row","Bent Over Two-Arm Long Bar Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"barbell"],
["db_bent_over_two_dumbbell_row","Bent Over Two-Dumbbell Row","dos",1.3,1,0,{dos:0.7,biceps:0.15,epaules:0.15},"dumbbell"],
["db_bent_over_two_dumbbell_row_with_pa","Bent Over Two-Dumbbell Row With Palms In","dos",1.3,1,0,{dos:0.7,biceps:0.3},"dumbbell"],
["db_bent_press","Bent Press","abdos",0.6,0,0,{abdos:0.7,fessiers:0.05,ischios:0.05,dos:0.05,quads:0.05,epaules:0.05,triceps:0.05},"kettlebells"],
["db_bicycling","Bicycling","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"other"],
["db_bicycling_stationary","Bicycling, Stationary","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_board_press","Board Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.07,biceps:0.07,dos:0.07,epaules:0.07},"barbell"],
["db_body_up","Body-Up","triceps",0.6,0,1,{triceps:0.7,abdos:0.15,biceps:0.15},"body only"],
["db_body_tricep_press","Body Tricep Press","triceps",0.6,0,1,{triceps:1.0},"body only"],
["db_bodyweight_flyes","Bodyweight Flyes","pecs",1.3,0,0,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"e-z curl bar"],
["db_bodyweight_mid_row","Bodyweight Mid Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_bodyweight_squat","Bodyweight Squat","quads",2.0,0,1,{quads:0.7,fessiers:0.15,ischios:0.15},"body only"],
["db_bodyweight_walking_lunge","Bodyweight Walking Lunge","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"autre"],
["db_bosu_ball_cable_crunch_with_side_b","Bosu Ball Cable Crunch With Side Bends","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_bottoms_up_clean_from_the_hang_pos","Bottoms-Up Clean From The Hang Position","biceps",0.6,0,0,{biceps:0.7,epaules:0.3},"kettlebells"],
["db_bottoms_up","Bottoms Up","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_box_jump_multiple_response","Box Jump (Multiple Response)","ischios",1.5,0,0,{ischios:0.7,fessiers:0.18,mollets:0.06,quads:0.06},"other"],
["db_box_skip","Box Skip","ischios",1.5,0,0,{ischios:0.7,fessiers:0.18,mollets:0.06,quads:0.06},"other"],
["db_box_squat","Box Squat","quads",2.0,0,0,{quads:0.7,fessiers:0.12,mollets:0.06,ischios:0.06,dos:0.06},"barbell"],
["db_box_squat_with_bands","Box Squat with Bands","quads",2.0,0,0,{quads:0.7,fessiers:0.15000000000000002,mollets:0.05,ischios:0.05,dos:0.05},"barbell"],
["db_box_squat_with_chains","Box Squat with Chains","quads",2.0,0,0,{quads:0.7,fessiers:0.15000000000000002,mollets:0.05,ischios:0.05,dos:0.05},"barbell"],
["db_brachialis_smr","Brachialis-SMR","biceps",0.6,0,0,{biceps:1.0},"foam roll"],
["db_bradford_rocky_presses","Bradford/Rocky Presses","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"barbell"],
["db_butt_ups","Butt-Ups","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_butt_lift_bridge","Butt Lift (Bridge)","fessiers",1.5,0,1,{fessiers:0.7,ischios:0.3},"body only"],
["db_butterfly","Butterfly","pecs",1.3,0,0,{pecs:1.0},"machine"],
["db_cable_chest_press","Cable Chest Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"cable"],
["db_cable_crossover","Cable Crossover","pecs",1.3,0,0,{pecs:0.7,epaules:0.3},"cable"],
["db_cable_crunch","Cable Crunch","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_cable_deadlifts","Cable Deadlifts","quads",2.0,0,0,{quads:0.7,biceps:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"cable"],
["db_cable_hammer_curls_rope_attachment","Cable Hammer Curls - Rope Attachment","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_cable_hip_adduction","Cable Hip Adduction","quads",2.0,0,0,{quads:1.0},"cable"],
["db_cable_incline_pushdown","Cable Incline Pushdown","dos",1.3,0,0,{dos:1.0},"cable"],
["db_cable_incline_triceps_extension","Cable Incline Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_cable_internal_rotation","Cable Internal Rotation","epaules",0.9,0,0,{epaules:1.0},"cable"],
["db_cable_iron_cross","Cable Iron Cross","pecs",1.3,0,0,{pecs:1.0},"cable"],
["db_cable_judo_flip","Cable Judo Flip","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_cable_lying_triceps_extension","Cable Lying Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_cable_one_arm_tricep_extension","Cable One Arm Tricep Extension","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_cable_preacher_curl","Cable Preacher Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_cable_rear_delt_fly","Cable Rear Delt Fly","epaules",0.9,0,0,{epaules:1.0},"cable"],
["db_cable_reverse_crunch","Cable Reverse Crunch","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_cable_rope_overhead_triceps_extens","Cable Rope Overhead Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_cable_rope_rear_delt_rows","Cable Rope Rear-Delt Rows","epaules",0.9,0,0,{epaules:0.7,biceps:0.15,dos:0.15},"cable"],
["db_cable_russian_twists","Cable Russian Twists","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_cable_seated_crunch","Cable Seated Crunch","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_cable_seated_lateral_raise","Cable Seated Lateral Raise","epaules",0.9,0,0,{epaules:0.7,dos:0.3},"cable"],
["db_cable_shoulder_press","Cable Shoulder Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"cable"],
["db_cable_shrugs","Cable Shrugs","epaules",0.9,0,0,{epaules:1.0},"cable"],
["db_cable_wrist_curl","Cable Wrist Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_calf_machine_shoulder_shrug","Calf-Machine Shoulder Shrug","epaules",0.9,0,0,{epaules:1.0},"machine"],
["db_calf_press","Calf Press","mollets",1.8,0,0,{mollets:1.0},"machine"],
["db_calf_press_on_the_leg_press_machin","Calf Press On The Leg Press Machine","mollets",1.8,0,0,{mollets:1.0},"machine"],
["db_calf_raise_on_a_dumbbell","Calf Raise On A Dumbbell","mollets",1.8,1,0,{mollets:1.0},"dumbbell"],
["db_calf_raises_with_bands","Calf Raises - With Bands","mollets",1.8,0,0,{mollets:1.0},"bands"],
["db_calf_stretch_elbows_against_wall","Calf Stretch Elbows Against Wall","mollets",1.8,0,0,{mollets:1.0},"autre"],
["db_calf_stretch_hands_against_wall","Calf Stretch Hands Against Wall","mollets",1.8,0,0,{mollets:1.0},"autre"],
["db_calves_smr","Calves-SMR","mollets",1.8,0,0,{mollets:1.0},"foam roll"],
["db_car_deadlift","Car Deadlift","quads",2.0,0,0,{quads:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,dos:0.06,epaules:0.06},"other"],
["db_car_drivers","Car Drivers","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"barbell"],
["db_carioca_quick_step","Carioca Quick Step","fessiers",1.5,0,0,{fessiers:0.7,abdos:0.07,mollets:0.07,ischios:0.07,quads:0.07},"autre"],
["db_cat_stretch","Cat Stretch","dos",1.3,0,0,{dos:0.7,epaules:0.3},"autre"],
["db_catch_and_overhead_throw","Catch and Overhead Throw","dos",1.3,0,0,{dos:0.7,abdos:0.1,pecs:0.1,epaules:0.1},"medicine ball"],
["db_chain_handle_extension","Chain Handle Extension","triceps",0.6,0,0,{triceps:1.0},"other"],
["db_chain_press","Chain Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"other"],
["db_chair_leg_extended_stretch","Chair Leg Extended Stretch","ischios",1.5,0,0,{ischios:0.7,fessiers:0.3},"other"],
["db_chair_lower_back_stretch","Chair Lower Back Stretch","dos",1.3,0,0,{dos:1.0},"autre"],
["db_chair_squat","Chair Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_chair_upper_body_stretch","Chair Upper Body Stretch","epaules",0.9,0,0,{epaules:0.7,biceps:0.15,pecs:0.15},"other"],
["db_chest_and_front_of_shoulder_stretc","Chest And Front Of Shoulder Stretch","pecs",1.3,0,0,{pecs:0.7,epaules:0.3},"other"],
["db_chest_push_from_3_point_stance","Chest Push from 3 point stance","pecs",1.3,0,0,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"medicine ball"],
["db_chest_push_multiple_response","Chest Push (multiple response)","pecs",1.3,0,0,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"medicine ball"],
["db_chest_push_single_response","Chest Push (single response)","pecs",1.3,0,0,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"medicine ball"],
["db_chest_push_with_run_release","Chest Push with Run Release","pecs",1.3,0,0,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"medicine ball"],
["db_chest_stretch_on_stability_ball","Chest Stretch on Stability Ball","pecs",1.3,0,0,{pecs:1.0},"exercise ball"],
["db_child_s_pose","Child's Pose","dos",1.3,0,0,{dos:0.7,fessiers:0.3},"autre"],
["db_chin_up","Chin-Up","dos",1.3,0,1,{dos:0.7,biceps:0.3},"body only"],
["db_chin_to_chest_stretch","Chin To Chest Stretch","epaules",0.9,0,0,{epaules:1.0},"autre"],
["db_circus_bell","Circus Bell","epaules",0.9,0,0,{epaules:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,dos:0.06,triceps:0.06},"other"],
["db_clean","Clean","ischios",1.5,0,0,{ischios:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,dos:0.04,quads:0.04,epaules:0.08},"barbell"],
["db_clean_deadlift","Clean Deadlift","ischios",1.5,0,0,{ischios:0.7,biceps:0.05,fessiers:0.05,dos:0.1,quads:0.05,epaules:0.05},"barbell"],
["db_clean_pull","Clean Pull","quads",2.0,0,0,{quads:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,dos:0.06,epaules:0.06},"barbell"],
["db_clean_shrug","Clean Shrug","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"barbell"],
["db_clean_and_jerk","Clean and Jerk","epaules",0.9,0,0,{epaules:0.7,abdos:0.05,fessiers:0.05,ischios:0.05,dos:0.05,quads:0.05,triceps:0.05},"barbell"],
["db_clean_and_press","Clean and Press","epaules",0.9,0,0,{epaules:0.7,abdos:0.04,mollets:0.04,fessiers:0.04,ischios:0.04,dos:0.08,quads:0.04,triceps:0.04},"barbell"],
["db_clean_from_blocks","Clean from Blocks","quads",2.0,0,0,{quads:0.7,mollets:0.06,fessiers:0.06,ischios:0.06,epaules:0.12},"barbell"],
["db_clock_push_up","Clock Push-Up","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_close_grip_barbell_bench_press","Close-Grip Barbell Bench Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"barbell"],
["db_close_grip_dumbbell_press","Close-Grip Dumbbell Press","triceps",0.6,1,0,{triceps:0.7,pecs:0.15,epaules:0.15},"dumbbell"],
["db_close_grip_ez_bar_curl_with_band","Close-Grip EZ-Bar Curl with Band","biceps",0.6,0,0,{biceps:1.0},"e-z curl bar"],
["db_close_grip_ez_bar_press","Close-Grip EZ-Bar Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"e-z curl bar"],
["db_close_grip_ez_bar_curl","Close-Grip EZ Bar Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_close_grip_front_lat_pulldown","Close-Grip Front Lat Pulldown","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_close_grip_push_up_off_of_a_dumbbe","Close-Grip Push-Up off of a Dumbbell","triceps",0.6,0,1,{triceps:0.7,abdos:0.1,pecs:0.1,epaules:0.1},"body only"],
["db_close_grip_standing_barbell_curl","Close-Grip Standing Barbell Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_cocoons","Cocoons","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_conan_s_wheel","Conan's Wheel","quads",2.0,0,0,{quads:0.7,abdos:0.04,biceps:0.08,mollets:0.04,dos:0.04,epaules:0.08},"other"],
["db_concentration_curls","Concentration Curls","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_cross_body_crunch","Cross-Body Crunch","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_cross_body_hammer_curl","Cross Body Hammer Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_cross_over_with_bands","Cross Over - With Bands","pecs",1.3,0,0,{pecs:0.7,biceps:0.15,epaules:0.15},"bands"],
["db_crossover_reverse_lunge","Crossover Reverse Lunge","dos",1.3,0,0,{dos:0.7,abdos:0.06,fessiers:0.12,ischios:0.06,quads:0.06},"autre"],
["db_crucifix","Crucifix","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"other"],
["db_crunch_hands_overhead","Crunch - Hands Overhead","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_crunch_legs_on_exercise_ball","Crunch - Legs On Exercise Ball","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_crunches","Crunches","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_cuban_press","Cuban Press","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_dancer_s_stretch","Dancer's Stretch","dos",1.3,0,0,{dos:0.7,fessiers:0.3},"autre"],
["db_dead_bug","Dead Bug","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_deadlift_with_bands","Deadlift with Bands","dos",1.3,0,0,{dos:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,quads:0.06,epaules:0.06},"barbell"],
["db_deadlift_with_chains","Deadlift with Chains","dos",1.3,0,0,{dos:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,quads:0.06,epaules:0.06},"barbell"],
["db_decline_barbell_bench_press","Decline Barbell Bench Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_decline_close_grip_bench_to_skull_","Decline Close-Grip Bench To Skull Crusher","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"barbell"],
["db_decline_crunch","Decline Crunch","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_decline_dumbbell_bench_press","Decline Dumbbell Bench Press","pecs",1.3,1,0,{pecs:0.7,epaules:0.15,triceps:0.15},"dumbbell"],
["db_decline_dumbbell_flyes","Decline Dumbbell Flyes","pecs",1.3,1,0,{pecs:1.0},"dumbbell"],
["db_decline_dumbbell_triceps_extension","Decline Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_decline_ez_bar_triceps_extension","Decline EZ Bar Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"barbell"],
["db_decline_oblique_crunch","Decline Oblique Crunch","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_decline_push_up","Decline Push-Up","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"autre"],
["db_decline_reverse_crunch","Decline Reverse Crunch","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_decline_smith_press","Decline Smith Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_deficit_deadlift","Deficit Deadlift","dos",1.3,0,0,{dos:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,quads:0.06,epaules:0.06},"barbell"],
["db_depth_jump_leap","Depth Jump Leap","quads",2.0,0,0,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"other"],
["db_dip_machine","Dip Machine","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"machine"],
["db_dips_chest_version","Dips - Chest Version","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"other"],
["db_dips_triceps_version","Dips - Triceps Version","triceps",0.6,0,1,{triceps:0.7,pecs:0.15,epaules:0.15},"body only"],
["db_donkey_calf_raises","Donkey Calf Raises","mollets",1.8,0,0,{mollets:1.0},"other"],
["db_double_kettlebell_alternating_hang","Double Kettlebell Alternating Hang Clean","ischios",1.5,0,0,{ischios:0.7,biceps:0.08,mollets:0.04,fessiers:0.04,dos:0.04,quads:0.04,epaules:0.04},"kettlebells"],
["db_double_kettlebell_jerk","Double Kettlebell Jerk","epaules",0.9,0,0,{epaules:0.7,mollets:0.1,quads:0.1,triceps:0.1},"kettlebells"],
["db_double_kettlebell_push_press","Double Kettlebell Push Press","epaules",0.9,0,0,{epaules:0.7,mollets:0.1,quads:0.1,triceps:0.1},"kettlebells"],
["db_double_kettlebell_snatch","Double Kettlebell Snatch","epaules",0.9,0,0,{epaules:0.7,fessiers:0.1,ischios:0.1,quads:0.1},"kettlebells"],
["db_double_kettlebell_windmill","Double Kettlebell Windmill","abdos",0.6,0,0,{abdos:0.7,fessiers:0.07,ischios:0.07,epaules:0.07,triceps:0.07},"kettlebells"],
["db_double_leg_butt_kick","Double Leg Butt Kick","quads",2.0,0,1,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"body only"],
["db_downward_facing_balance","Downward Facing Balance","fessiers",1.5,0,0,{fessiers:0.7,abdos:0.15,ischios:0.15},"exercise ball"],
["db_drag_curl","Drag Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_drop_push","Drop Push","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"other"],
["db_dumbbell_alternate_bicep_curl","Dumbbell Alternate Bicep Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_dumbbell_bench_press","Dumbbell Bench Press","pecs",1.3,1,0,{pecs:0.7,epaules:0.15,triceps:0.15},"dumbbell"],
["db_dumbbell_bench_press_with_neutral_","Dumbbell Bench Press with Neutral Grip","pecs",1.3,1,0,{pecs:0.7,epaules:0.15,triceps:0.15},"dumbbell"],
["db_dumbbell_bicep_curl","Dumbbell Bicep Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_dumbbell_clean","Dumbbell Clean","ischios",1.5,1,0,{ischios:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,dos:0.04,quads:0.04,epaules:0.08},"dumbbell"],
["db_dumbbell_floor_press","Dumbbell Floor Press","triceps",0.6,1,0,{triceps:0.7,pecs:0.15,epaules:0.15},"dumbbell"],
["db_dumbbell_flyes","Dumbbell Flyes","pecs",1.3,1,0,{pecs:1.0},"dumbbell"],
["db_dumbbell_incline_row","Dumbbell Incline Row","dos",1.3,1,0,{dos:0.7,biceps:0.2,epaules:0.1},"dumbbell"],
["db_dumbbell_incline_shoulder_raise","Dumbbell Incline Shoulder Raise","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_dumbbell_lunges","Dumbbell Lunges","quads",2.0,1,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"dumbbell"],
["db_dumbbell_lying_one_arm_rear_latera","Dumbbell Lying One-Arm Rear Lateral Raise","epaules",0.9,1,0,{epaules:0.7,dos:0.3},"dumbbell"],
["db_dumbbell_lying_pronation","Dumbbell Lying Pronation","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_dumbbell_lying_rear_lateral_raise","Dumbbell Lying Rear Lateral Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_dumbbell_lying_supination","Dumbbell Lying Supination","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_dumbbell_one_arm_shoulder_press","Dumbbell One-Arm Shoulder Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_dumbbell_one_arm_triceps_extension","Dumbbell One-Arm Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_dumbbell_one_arm_upright_row","Dumbbell One-Arm Upright Row","epaules",0.9,1,0,{epaules:0.7,biceps:0.3},"dumbbell"],
["db_dumbbell_prone_incline_curl","Dumbbell Prone Incline Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_dumbbell_raise","Dumbbell Raise","epaules",0.9,1,0,{epaules:0.7,biceps:0.3},"dumbbell"],
["db_dumbbell_rear_lunge","Dumbbell Rear Lunge","quads",2.0,1,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"dumbbell"],
["db_dumbbell_scaption","Dumbbell Scaption","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_dumbbell_seated_box_jump","Dumbbell Seated Box Jump","quads",2.0,1,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"dumbbell"],
["db_dumbbell_seated_one_leg_calf_raise","Dumbbell Seated One-Leg Calf Raise","mollets",1.8,1,0,{mollets:1.0},"dumbbell"],
["db_dumbbell_shoulder_press","Dumbbell Shoulder Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_dumbbell_shrug","Dumbbell Shrug","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_dumbbell_side_bend","Dumbbell Side Bend","abdos",0.6,1,0,{abdos:1.0},"dumbbell"],
["db_dumbbell_squat","Dumbbell Squat","quads",2.0,1,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"dumbbell"],
["db_dumbbell_squat_to_a_bench","Dumbbell Squat To A Bench","quads",2.0,1,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"dumbbell"],
["db_dumbbell_step_ups","Dumbbell Step Ups","quads",2.0,1,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"dumbbell"],
["db_dumbbell_tricep_extension_pronated","Dumbbell Tricep Extension -Pronated Grip","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_dynamic_back_stretch","Dynamic Back Stretch","dos",1.3,0,0,{dos:1.0},"autre"],
["db_dynamic_chest_stretch","Dynamic Chest Stretch","pecs",1.3,0,0,{pecs:0.7,dos:0.3},"autre"],
["db_ez_bar_curl","EZ-Bar Curl","biceps",0.6,0,0,{biceps:1.0},"e-z curl bar"],
["db_ez_bar_skullcrusher","EZ-Bar Skullcrusher","triceps",0.6,0,0,{triceps:0.7,biceps:0.3},"e-z curl bar"],
["db_elbow_circles","Elbow Circles","epaules",0.9,0,0,{epaules:1.0},"autre"],
["db_elbow_to_knee","Elbow to Knee","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_elbows_back","Elbows Back","pecs",1.3,0,0,{pecs:0.7,epaules:0.3},"autre"],
["db_elevated_back_lunge","Elevated Back Lunge","quads",2.0,0,0,{quads:0.7,fessiers:0.15,ischios:0.15},"barbell"],
["db_elevated_cable_rows","Elevated Cable Rows","dos",1.3,0,0,{dos:0.7,epaules:0.3},"cable"],
["db_elliptical_trainer","Elliptical Trainer","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_exercise_ball_crunch","Exercise Ball Crunch","abdos",0.6,0,0,{abdos:1.0},"exercise ball"],
["db_exercise_ball_pull_in","Exercise Ball Pull-In","abdos",0.6,0,0,{abdos:1.0},"exercise ball"],
["db_extended_range_one_arm_kettlebell_","Extended Range One-Arm Kettlebell Floor Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"kettlebells"],
["db_external_rotation","External Rotation","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_external_rotation_with_band","External Rotation with Band","epaules",0.9,0,0,{epaules:1.0},"bands"],
["db_external_rotation_with_cable","External Rotation with Cable","epaules",0.9,0,0,{epaules:1.0},"cable"],
["db_face_pull","Face Pull","epaules",0.9,0,0,{epaules:0.7,dos:0.3},"cable"],
["db_farmer_s_walk","Farmer's Walk","biceps",0.6,0,0,{biceps:0.7,abdos:0.05,fessiers:0.05,ischios:0.05,dos:0.05,quads:0.05,epaules:0.05},"other"],
["db_fast_skipping","Fast Skipping","quads",2.0,0,1,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"body only"],
["db_finger_curls","Finger Curls","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_flat_bench_cable_flyes","Flat Bench Cable Flyes","pecs",1.3,0,0,{pecs:1.0},"cable"],
["db_flat_bench_leg_pull_in","Flat Bench Leg Pull-In","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_flat_bench_lying_leg_raise","Flat Bench Lying Leg Raise","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_flexor_incline_dumbbell_curls","Flexor Incline Dumbbell Curls","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_floor_glute_ham_raise","Floor Glute-Ham Raise","ischios",1.5,0,0,{ischios:0.7,mollets:0.15,fessiers:0.15},"autre"],
["db_floor_press","Floor Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"barbell"],
["db_floor_press_with_chains","Floor Press with Chains","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"barbell"],
["db_flutter_kicks","Flutter Kicks","fessiers",1.5,0,1,{fessiers:0.7,ischios:0.3},"body only"],
["db_foot_smr","Foot-SMR","mollets",1.8,0,0,{mollets:1.0},"other"],
["db_forward_drag_with_press","Forward Drag with Press","pecs",1.3,0,0,{pecs:0.7,mollets:0.05,fessiers:0.05,ischios:0.05,quads:0.05,epaules:0.05,triceps:0.05},"other"],
["db_frankenstein_squat","Frankenstein Squat","quads",2.0,0,0,{quads:0.7,abdos:0.07,mollets:0.07,fessiers:0.07,ischios:0.07},"barbell"],
["db_freehand_jump_squat","Freehand Jump Squat","quads",2.0,0,1,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"body only"],
["db_frog_hops","Frog Hops","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"autre"],
["db_frog_sit_ups","Frog Sit-Ups","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_front_barbell_squat","Front Barbell Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_front_barbell_squat_to_a_bench","Front Barbell Squat To A Bench","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_front_box_jump","Front Box Jump","ischios",1.5,0,0,{ischios:0.7,fessiers:0.18,mollets:0.06,quads:0.06},"other"],
["db_front_cable_raise","Front Cable Raise","epaules",0.9,0,0,{epaules:1.0},"cable"],
["db_front_cone_hops_or_hurdle_hops","Front Cone Hops (or hurdle hops)","quads",2.0,0,0,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"other"],
["db_front_dumbbell_raise","Front Dumbbell Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_front_incline_dumbbell_raise","Front Incline Dumbbell Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_front_leg_raises","Front Leg Raises","ischios",1.5,0,1,{ischios:1.0},"body only"],
["db_front_plate_raise","Front Plate Raise","epaules",0.9,0,0,{epaules:1.0},"other"],
["db_front_raise_and_pullover","Front Raise And Pullover","pecs",1.3,0,0,{pecs:0.7,dos:0.1,epaules:0.1,triceps:0.1},"barbell"],
["db_front_squat_clean_grip","Front Squat (Clean Grip)","quads",2.0,0,0,{quads:0.7,abdos:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_front_squats_with_two_kettlebells","Front Squats With Two Kettlebells","quads",2.0,0,0,{quads:0.7,mollets:0.15,fessiers:0.15},"kettlebells"],
["db_front_two_dumbbell_raise","Front Two-Dumbbell Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_full_range_of_motion_lat_pulldown","Full Range-Of-Motion Lat Pulldown","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_gironda_sternum_chins","Gironda Sternum Chins","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_glute_ham_raise","Glute Ham Raise","ischios",1.5,0,0,{ischios:0.7,mollets:0.15,fessiers:0.15},"machine"],
["db_glute_kickback","Glute Kickback","fessiers",1.5,0,1,{fessiers:0.7,ischios:0.3},"body only"],
["db_goblet_squat","Goblet Squat","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,epaules:0.07},"kettlebells"],
["db_good_morning","Good Morning","ischios",1.5,0,0,{ischios:0.7,abdos:0.1,fessiers:0.1,dos:0.1},"barbell"],
["db_good_morning_off_pins","Good Morning off Pins","ischios",1.5,0,0,{ischios:0.7,abdos:0.1,fessiers:0.1,dos:0.1},"barbell"],
["db_gorilla_chin_crunch","Gorilla Chin/Crunch","abdos",0.6,0,1,{abdos:0.7,biceps:0.15,dos:0.15},"body only"],
["db_groin_and_back_stretch","Groin and Back Stretch","fessiers",1.5,0,0,{fessiers:1.0},"autre"],
["db_groiners","Groiners","fessiers",1.5,0,1,{fessiers:1.0},"body only"],
["db_hack_squat","Hack Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_hammer_curls","Hammer Curls","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_hammer_grip_incline_db_bench_press","Hammer Grip Incline DB Bench Press","pecs",1.3,1,0,{pecs:0.7,epaules:0.15,triceps:0.15},"dumbbell"],
["db_hamstring_smr","Hamstring-SMR","ischios",1.5,0,0,{ischios:1.0},"foam roll"],
["db_hamstring_stretch","Hamstring Stretch","ischios",1.5,0,0,{ischios:1.0},"autre"],
["db_handstand_push_ups","Handstand Push-Ups","epaules",0.9,0,1,{epaules:0.7,triceps:0.3},"body only"],
["db_hang_clean","Hang Clean","quads",2.0,0,0,{quads:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,ischios:0.04,dos:0.04,epaules:0.08},"barbell"],
["db_hang_clean_below_the_knees","Hang Clean - Below the Knees","quads",2.0,0,0,{quads:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,ischios:0.04,dos:0.04,epaules:0.08},"barbell"],
["db_hang_snatch","Hang Snatch","ischios",1.5,0,0,{ischios:0.7,abdos:0.04,mollets:0.04,biceps:0.04,fessiers:0.04,dos:0.04,quads:0.04,epaules:0.08},"barbell"],
["db_hang_snatch_below_knees","Hang Snatch - Below Knees","ischios",1.5,0,0,{ischios:0.7,abdos:0.04,mollets:0.04,biceps:0.04,fessiers:0.04,dos:0.04,quads:0.04,epaules:0.08},"barbell"],
["db_hanging_bar_good_morning","Hanging Bar Good Morning","ischios",1.5,0,0,{ischios:0.7,abdos:0.1,fessiers:0.1,dos:0.1},"barbell"],
["db_hanging_leg_raise","Hanging Leg Raise","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_hanging_pike","Hanging Pike","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_heaving_snatch_balance","Heaving Snatch Balance","quads",2.0,0,0,{quads:0.7,abdos:0.05,biceps:0.05,fessiers:0.05,ischios:0.05,epaules:0.05,triceps:0.05},"barbell"],
["db_heavy_bag_thrust","Heavy Bag Thrust","pecs",1.3,0,0,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"other"],
["db_high_cable_curls","High Cable Curls","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_hip_circles_prone","Hip Circles (prone)","fessiers",1.5,0,1,{fessiers:1.0},"body only"],
["db_hip_extension_with_bands","Hip Extension with Bands","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.3},"bands"],
["db_hip_flexion_with_band","Hip Flexion with Band","quads",2.0,0,0,{quads:1.0},"bands"],
["db_hip_lift_with_band","Hip Lift with Band","fessiers",1.5,0,0,{fessiers:0.7,mollets:0.15,ischios:0.15},"bands"],
["db_hug_a_ball","Hug A Ball","dos",1.3,0,0,{dos:0.7,mollets:0.15,fessiers:0.15},"exercise ball"],
["db_hug_knees_to_chest","Hug Knees To Chest","dos",1.3,0,0,{dos:0.7,fessiers:0.3},"autre"],
["db_hurdle_hops","Hurdle Hops","ischios",1.5,0,0,{ischios:0.7,fessiers:0.21000000000000002,mollets:0.07},"other"],
["db_hyperextensions_back_extensions","Hyperextensions (Back Extensions)","dos",1.3,0,0,{dos:0.7,fessiers:0.15,ischios:0.15},"other"],
["db_hyperextensions_with_no_hyperexten","Hyperextensions With No Hyperextension Bench","dos",1.3,0,1,{dos:0.7,fessiers:0.15,ischios:0.15},"body only"],
["db_it_band_and_glute_stretch","IT Band and Glute Stretch","fessiers",1.5,0,0,{fessiers:1.0},"other"],
["db_iliotibial_tract_smr","Iliotibial Tract-SMR","fessiers",1.5,0,0,{fessiers:1.0},"foam roll"],
["db_inchworm","Inchworm","ischios",1.5,0,1,{ischios:1.0},"body only"],
["db_incline_barbell_triceps_extension","Incline Barbell Triceps Extension","triceps",0.6,0,0,{triceps:0.7,biceps:0.3},"barbell"],
["db_incline_bench_pull","Incline Bench Pull","dos",1.3,0,0,{dos:0.7,epaules:0.3},"barbell"],
["db_incline_cable_chest_press","Incline Cable Chest Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"cable"],
["db_incline_cable_flye","Incline Cable Flye","pecs",1.3,0,0,{pecs:0.7,epaules:0.3},"cable"],
["db_incline_dumbbell_bench_with_palms_","Incline Dumbbell Bench With Palms Facing In","pecs",1.3,1,0,{pecs:0.7,epaules:0.15,triceps:0.15},"dumbbell"],
["db_incline_dumbbell_curl","Incline Dumbbell Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_incline_dumbbell_flyes","Incline Dumbbell Flyes","pecs",1.3,1,0,{pecs:0.7,epaules:0.3},"dumbbell"],
["db_incline_dumbbell_flyes_with_a_twis","Incline Dumbbell Flyes - With A Twist","pecs",1.3,1,0,{pecs:0.7,epaules:0.3},"dumbbell"],
["db_incline_dumbbell_press","Incline Dumbbell Press","pecs",1.3,1,0,{pecs:0.7,epaules:0.15,triceps:0.15},"dumbbell"],
["db_incline_hammer_curls","Incline Hammer Curls","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_incline_inner_biceps_curl","Incline Inner Biceps Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_incline_push_up","Incline Push-Up","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_incline_push_up_close_grip","Incline Push-Up Close-Grip","triceps",0.6,0,1,{triceps:0.7,pecs:0.15,epaules:0.15},"body only"],
["db_incline_push_up_depth_jump","Incline Push-Up Depth Jump","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"other"],
["db_incline_push_up_medium","Incline Push-Up Medium","pecs",1.3,0,1,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"body only"],
["db_incline_push_up_reverse_grip","Incline Push-Up Reverse Grip","pecs",1.3,0,1,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"body only"],
["db_incline_push_up_wide","Incline Push-Up Wide","pecs",1.3,0,1,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"body only"],
["db_intermediate_groin_stretch","Intermediate Groin Stretch","ischios",1.5,0,0,{ischios:1.0},"other"],
["db_intermediate_hip_flexor_and_quad_s","Intermediate Hip Flexor and Quad Stretch","quads",2.0,0,0,{quads:1.0},"other"],
["db_internal_rotation_with_band","Internal Rotation with Band","epaules",0.9,0,0,{epaules:1.0},"bands"],
["db_inverted_row","Inverted Row","dos",1.3,0,0,{dos:1.0},"autre"],
["db_inverted_row_with_straps","Inverted Row with Straps","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_iron_cross","Iron Cross","epaules",0.9,1,0,{epaules:0.7,pecs:0.06,fessiers:0.06,ischios:0.06,dos:0.06,quads:0.06},"dumbbell"],
["db_iron_crosses_stretch","Iron Crosses (stretch)","quads",2.0,0,0,{quads:1.0},"autre"],
["db_isometric_chest_squeezes","Isometric Chest Squeezes","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_isometric_neck_exercise_front_and_","Isometric Neck Exercise - Front And Back","epaules",0.9,0,1,{epaules:1.0},"body only"],
["db_isometric_neck_exercise_sides","Isometric Neck Exercise - Sides","epaules",0.9,0,1,{epaules:1.0},"body only"],
["db_isometric_wipers","Isometric Wipers","pecs",1.3,0,1,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"body only"],
["db_jm_press","JM Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"barbell"],
["db_jackknife_sit_up","Jackknife Sit-Up","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_janda_sit_up","Janda Sit-Up","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_jefferson_squats","Jefferson Squats","quads",2.0,0,0,{quads:0.7,mollets:0.06,fessiers:0.06,ischios:0.06,dos:0.06,epaules:0.06},"barbell"],
["db_jerk_balance","Jerk Balance","epaules",0.9,0,0,{epaules:0.7,fessiers:0.07,ischios:0.07,quads:0.07,triceps:0.07},"barbell"],
["db_jerk_dip_squat","Jerk Dip Squat","quads",2.0,0,0,{quads:0.7,abdos:0.15,mollets:0.15},"barbell"],
["db_jogging_treadmill","Jogging, Treadmill","quads",2.0,0,0,{quads:0.7,fessiers:0.15,ischios:0.15},"machine"],
["db_keg_load","Keg Load","dos",1.3,0,0,{dos:0.7,abdos:0.03,biceps:0.06,mollets:0.03,fessiers:0.03,ischios:0.03,quads:0.03,epaules:0.06},"other"],
["db_kettlebell_arnold_press","Kettlebell Arnold Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"kettlebells"],
["db_kettlebell_dead_clean","Kettlebell Dead Clean","ischios",1.5,0,0,{ischios:0.7,mollets:0.06,fessiers:0.06,dos:0.06,quads:0.06,epaules:0.06},"kettlebells"],
["db_kettlebell_figure_8","Kettlebell Figure 8","abdos",0.6,0,0,{abdos:0.7,ischios:0.15,epaules:0.15},"kettlebells"],
["db_kettlebell_hang_clean","Kettlebell Hang Clean","ischios",1.5,0,0,{ischios:0.7,mollets:0.06,fessiers:0.06,dos:0.06,epaules:0.12},"kettlebells"],
["db_kettlebell_one_legged_deadlift","Kettlebell One-Legged Deadlift","ischios",1.5,0,0,{ischios:0.7,fessiers:0.15,dos:0.15},"kettlebells"],
["db_kettlebell_pass_between_the_legs","Kettlebell Pass Between The Legs","abdos",0.6,0,0,{abdos:0.7,fessiers:0.1,ischios:0.1,epaules:0.1},"kettlebells"],
["db_kettlebell_pirate_ships","Kettlebell Pirate Ships","epaules",0.9,0,0,{epaules:0.7,abdos:0.3},"kettlebells"],
["db_kettlebell_pistol_squat","Kettlebell Pistol Squat","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,epaules:0.07},"kettlebells"],
["db_kettlebell_seated_press","Kettlebell Seated Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"kettlebells"],
["db_kettlebell_seesaw_press","Kettlebell Seesaw Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"kettlebells"],
["db_kettlebell_sumo_high_pull","Kettlebell Sumo High Pull","epaules",0.9,0,0,{epaules:0.7,fessiers:0.14,ischios:0.07,quads:0.07},"kettlebells"],
["db_kettlebell_thruster","Kettlebell Thruster","epaules",0.9,0,0,{epaules:0.7,quads:0.15,triceps:0.15},"kettlebells"],
["db_kettlebell_turkish_get_up_lunge_st","Kettlebell Turkish Get-Up (Lunge style)","epaules",0.9,0,0,{epaules:0.7,abdos:0.07,ischios:0.07,quads:0.07,triceps:0.07},"kettlebells"],
["db_kettlebell_turkish_get_up_squat_st","Kettlebell Turkish Get-Up (Squat style)","epaules",0.9,0,0,{epaules:0.7,abdos:0.06,mollets:0.06,ischios:0.06,quads:0.06,triceps:0.06},"kettlebells"],
["db_kettlebell_windmill","Kettlebell Windmill","abdos",0.6,0,0,{abdos:0.7,fessiers:0.07,ischios:0.07,epaules:0.07,triceps:0.07},"kettlebells"],
["db_kipping_muscle_up","Kipping Muscle Up","dos",1.3,0,0,{dos:0.7,abdos:0.05,biceps:0.1,epaules:0.1,triceps:0.05},"other"],
["db_knee_across_the_body","Knee Across The Body","fessiers",1.5,0,0,{fessiers:0.7,dos:0.3},"autre"],
["db_knee_circles","Knee Circles","mollets",1.8,0,1,{mollets:0.7,ischios:0.15,quads:0.15},"body only"],
["db_knee_hip_raise_on_parallel_bars","Knee/Hip Raise On Parallel Bars","abdos",0.6,0,0,{abdos:1.0},"other"],
["db_knee_tuck_jump","Knee Tuck Jump","ischios",1.5,0,1,{ischios:0.7,fessiers:0.18,mollets:0.06,quads:0.06},"body only"],
["db_kneeling_arm_drill","Kneeling Arm Drill","epaules",0.9,0,0,{epaules:0.7,abdos:0.3},"autre"],
["db_kneeling_cable_crunch_with_alterna","Kneeling Cable Crunch With Alternating Oblique Twists","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_kneeling_cable_triceps_extension","Kneeling Cable Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_kneeling_forearm_stretch","Kneeling Forearm Stretch","biceps",0.6,0,0,{biceps:1.0},"autre"],
["db_kneeling_high_pulley_row","Kneeling High Pulley Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"cable"],
["db_kneeling_hip_flexor","Kneeling Hip Flexor","quads",2.0,0,0,{quads:1.0},"autre"],
["db_kneeling_jump_squat","Kneeling Jump Squat","fessiers",1.5,0,0,{fessiers:0.7,mollets:0.1,ischios:0.1,quads:0.1},"barbell"],
["db_kneeling_single_arm_high_pulley_ro","Kneeling Single-Arm High Pulley Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"cable"],
["db_kneeling_squat","Kneeling Squat","fessiers",1.5,0,0,{fessiers:0.7,abdos:0.1,ischios:0.1,dos:0.1},"barbell"],
["db_landmine_180_s","Landmine 180's","abdos",0.6,0,0,{abdos:0.7,fessiers:0.1,dos:0.1,epaules:0.1},"barbell"],
["db_landmine_linear_jammer","Landmine Linear Jammer","epaules",0.9,0,0,{epaules:0.7,abdos:0.05,mollets:0.05,pecs:0.05,ischios:0.05,quads:0.05,triceps:0.05},"barbell"],
["db_lateral_bound","Lateral Bound","fessiers",1.5,0,1,{fessiers:0.7,mollets:0.1,ischios:0.1,quads:0.1},"body only"],
["db_lateral_box_jump","Lateral Box Jump","fessiers",1.5,0,0,{fessiers:0.7,mollets:0.1,ischios:0.1,quads:0.1},"other"],
["db_lateral_cone_hops","Lateral Cone Hops","fessiers",1.5,0,0,{fessiers:0.7,mollets:0.1,ischios:0.1,quads:0.1},"other"],
["db_lateral_raise_with_bands","Lateral Raise - With Bands","epaules",0.9,0,0,{epaules:1.0},"bands"],
["db_latissimus_dorsi_smr","Latissimus Dorsi-SMR","dos",1.3,0,0,{dos:1.0},"foam roll"],
["db_leg_over_floor_press","Leg-Over Floor Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"kettlebells"],
["db_leg_up_hamstring_stretch","Leg-Up Hamstring Stretch","ischios",1.5,0,0,{ischios:1.0},"autre"],
["db_leg_extensions","Leg Extensions","quads",2.0,0,0,{quads:1.0},"machine"],
["db_leg_lift","Leg Lift","fessiers",1.5,0,1,{fessiers:0.7,ischios:0.3},"body only"],
["db_leg_press","Leg Press","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_leg_pull_in","Leg Pull-In","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_leverage_chest_press","Leverage Chest Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_leverage_deadlift","Leverage Deadlift","quads",2.0,0,0,{quads:0.7,fessiers:0.15,ischios:0.15},"machine"],
["db_leverage_decline_chest_press","Leverage Decline Chest Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_leverage_high_row","Leverage High Row","dos",1.3,0,0,{dos:1.0},"machine"],
["db_leverage_incline_chest_press","Leverage Incline Chest Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_leverage_iso_row","Leverage Iso Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"machine"],
["db_leverage_shoulder_press","Leverage Shoulder Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"machine"],
["db_leverage_shrug","Leverage Shrug","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"machine"],
["db_linear_3_part_start_technique","Linear 3-Part Start Technique","ischios",1.5,0,0,{ischios:0.7,mollets:0.15,quads:0.15},"autre"],
["db_linear_acceleration_wall_drill","Linear Acceleration Wall Drill","ischios",1.5,0,0,{ischios:0.7,mollets:0.1,fessiers:0.1,quads:0.1},"autre"],
["db_linear_depth_jump","Linear Depth Jump","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"other"],
["db_log_lift","Log Lift","epaules",0.9,0,0,{epaules:0.7,abdos:0.04,pecs:0.04,fessiers:0.04,ischios:0.04,dos:0.08,quads:0.04,triceps:0.04},"other"],
["db_london_bridges","London Bridges","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_looking_at_ceiling","Looking At Ceiling","quads",2.0,0,0,{quads:1.0},"autre"],
["db_low_cable_crossover","Low Cable Crossover","pecs",1.3,0,0,{pecs:0.7,epaules:0.3},"cable"],
["db_low_cable_triceps_extension","Low Cable Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_low_pulley_row_to_neck","Low Pulley Row To Neck","epaules",0.9,0,0,{epaules:0.7,biceps:0.15,dos:0.15},"cable"],
["db_lower_back_smr","Lower Back-SMR","dos",1.3,0,0,{dos:1.0},"foam roll"],
["db_lower_back_curl","Lower Back Curl","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_lunge_pass_through","Lunge Pass Through","ischios",1.5,0,0,{ischios:0.7,mollets:0.1,fessiers:0.1,quads:0.1},"kettlebells"],
["db_lunge_sprint","Lunge Sprint","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_lying_bent_leg_groin","Lying Bent Leg Groin","fessiers",1.5,0,0,{fessiers:1.0},"other"],
["db_lying_cable_curl","Lying Cable Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_lying_cambered_barbell_row","Lying Cambered Barbell Row","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"barbell"],
["db_lying_close_grip_bar_curl_on_high_","Lying Close-Grip Bar Curl On High Pulley","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_lying_close_grip_barbell_triceps_e","Lying Close-Grip Barbell Triceps Extension Behind The Head","triceps",0.6,0,0,{triceps:1.0},"barbell"],
["db_lying_close_grip_barbell_triceps_p","Lying Close-Grip Barbell Triceps Press To Chin","triceps",0.6,0,0,{triceps:1.0},"e-z curl bar"],
["db_lying_crossover","Lying Crossover","fessiers",1.5,0,1,{fessiers:1.0},"body only"],
["db_lying_dumbbell_tricep_extension","Lying Dumbbell Tricep Extension","triceps",0.6,1,0,{triceps:0.7,pecs:0.15,epaules:0.15},"dumbbell"],
["db_lying_face_down_plate_neck_resista","Lying Face Down Plate Neck Resistance","epaules",0.9,0,0,{epaules:1.0},"other"],
["db_lying_face_up_plate_neck_resistanc","Lying Face Up Plate Neck Resistance","epaules",0.9,0,0,{epaules:1.0},"other"],
["db_lying_glute","Lying Glute","fessiers",1.5,0,1,{fessiers:1.0},"body only"],
["db_lying_hamstring","Lying Hamstring","ischios",1.5,0,0,{ischios:0.7,mollets:0.3},"other"],
["db_lying_high_bench_barbell_curl","Lying High Bench Barbell Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_lying_leg_curls","Lying Leg Curls","ischios",1.5,0,0,{ischios:1.0},"machine"],
["db_lying_machine_squat","Lying Machine Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_lying_one_arm_lateral_raise","Lying One-Arm Lateral Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_lying_prone_quadriceps","Lying Prone Quadriceps","quads",2.0,0,1,{quads:1.0},"body only"],
["db_lying_rear_delt_raise","Lying Rear Delt Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_lying_supine_dumbbell_curl","Lying Supine Dumbbell Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_lying_t_bar_row","Lying T-Bar Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"machine"],
["db_lying_triceps_press","Lying Triceps Press","triceps",0.6,0,0,{triceps:1.0},"e-z curl bar"],
["db_machine_bench_press","Machine Bench Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_machine_bicep_curl","Machine Bicep Curl","biceps",0.6,0,0,{biceps:1.0},"machine"],
["db_machine_preacher_curls","Machine Preacher Curls","biceps",0.6,0,0,{biceps:1.0},"machine"],
["db_machine_shoulder_military_press","Machine Shoulder (Military) Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"machine"],
["db_machine_triceps_extension","Machine Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"machine"],
["db_medicine_ball_chest_pass","Medicine Ball Chest Pass","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"medicine ball"],
["db_medicine_ball_full_twist","Medicine Ball Full Twist","abdos",0.6,0,0,{abdos:0.7,epaules:0.3},"medicine ball"],
["db_medicine_ball_scoop_throw","Medicine Ball Scoop Throw","epaules",0.9,0,0,{epaules:0.7,abdos:0.1,ischios:0.1,quads:0.1},"medicine ball"],
["db_middle_back_shrug","Middle Back Shrug","dos",1.3,1,0,{dos:1.0},"dumbbell"],
["db_middle_back_stretch","Middle Back Stretch","dos",1.3,0,0,{dos:0.7,abdos:0.3},"autre"],
["db_mixed_grip_chin","Mixed Grip Chin","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_monster_walk","Monster Walk","fessiers",1.5,0,0,{fessiers:1.0},"bands"],
["db_mountain_climbers","Mountain Climbers","quads",2.0,0,0,{quads:0.7,pecs:0.1,ischios:0.1,epaules:0.1},"autre"],
["db_moving_claw_series","Moving Claw Series","ischios",1.5,0,0,{ischios:0.7,mollets:0.15,quads:0.15},"autre"],
["db_muscle_snatch","Muscle Snatch","ischios",1.5,0,0,{ischios:0.7,fessiers:0.06,dos:0.06,quads:0.06,epaules:0.06,triceps:0.06},"barbell"],
["db_muscle_up","Muscle Up","dos",1.3,0,0,{dos:0.7,abdos:0.05,biceps:0.1,epaules:0.1,triceps:0.05},"other"],
["db_narrow_stance_hack_squats","Narrow Stance Hack Squats","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_narrow_stance_leg_press","Narrow Stance Leg Press","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_narrow_stance_squats","Narrow Stance Squats","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"barbell"],
["db_natural_glute_ham_raise","Natural Glute Ham Raise","ischios",1.5,0,1,{ischios:0.7,mollets:0.1,fessiers:0.1,dos:0.1},"body only"],
["db_neck_smr","Neck-SMR","epaules",0.9,0,0,{epaules:1.0},"other"],
["db_neck_press","Neck Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_oblique_crunches","Oblique Crunches","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_oblique_crunches_on_the_floor","Oblique Crunches - On The Floor","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_olympic_squat","Olympic Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_on_your_back_quad_stretch","On-Your-Back Quad Stretch","quads",2.0,0,0,{quads:1.0},"other"],
["db_on_your_side_quad_stretch","On Your Side Quad Stretch","quads",2.0,0,0,{quads:1.0},"autre"],
["db_one_arm_dumbbell_row","One-Arm Dumbbell Row","dos",1.3,1,0,{dos:0.7,biceps:0.15,epaules:0.15},"dumbbell"],
["db_one_arm_flat_bench_dumbbell_flye","One-Arm Flat Bench Dumbbell Flye","pecs",1.3,1,0,{pecs:1.0},"dumbbell"],
["db_one_arm_high_pulley_cable_side_ben","One-Arm High-Pulley Cable Side Bends","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_one_arm_incline_lateral_raise","One-Arm Incline Lateral Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_one_arm_kettlebell_clean","One-Arm Kettlebell Clean","ischios",1.5,0,0,{ischios:0.7,fessiers:0.07,dos:0.07,epaules:0.14},"kettlebells"],
["db_one_arm_kettlebell_clean_and_jerk","One-Arm Kettlebell Clean and Jerk","epaules",0.9,0,0,{epaules:1.0},"kettlebells"],
["db_one_arm_kettlebell_floor_press","One-Arm Kettlebell Floor Press","pecs",1.3,0,0,{pecs:0.7,triceps:0.3},"kettlebells"],
["db_one_arm_kettlebell_jerk","One-Arm Kettlebell Jerk","epaules",0.9,0,0,{epaules:0.7,mollets:0.1,quads:0.1,triceps:0.1},"kettlebells"],
["db_one_arm_kettlebell_military_press_","One-Arm Kettlebell Military Press To The Side","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"kettlebells"],
["db_one_arm_kettlebell_para_press","One-Arm Kettlebell Para Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"kettlebells"],
["db_one_arm_kettlebell_push_press","One-Arm Kettlebell Push Press","epaules",0.9,0,0,{epaules:0.7,mollets:0.1,quads:0.1,triceps:0.1},"kettlebells"],
["db_one_arm_kettlebell_row","One-Arm Kettlebell Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"kettlebells"],
["db_one_arm_kettlebell_snatch","One-Arm Kettlebell Snatch","epaules",0.9,0,0,{epaules:0.7,mollets:0.06,fessiers:0.06,ischios:0.06,dos:0.06,triceps:0.06},"kettlebells"],
["db_one_arm_kettlebell_split_jerk","One-Arm Kettlebell Split Jerk","epaules",0.9,0,0,{epaules:0.7,fessiers:0.07,ischios:0.07,quads:0.07,triceps:0.07},"kettlebells"],
["db_one_arm_kettlebell_split_snatch","One-Arm Kettlebell Split Snatch","epaules",0.9,0,0,{epaules:0.7,ischios:0.15,quads:0.15},"kettlebells"],
["db_one_arm_kettlebell_swings","One-Arm Kettlebell Swings","ischios",1.5,0,0,{ischios:0.7,mollets:0.07,fessiers:0.07,dos:0.07,epaules:0.07},"kettlebells"],
["db_one_arm_long_bar_row","One-Arm Long Bar Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"barbell"],
["db_one_arm_medicine_ball_slam","One-Arm Medicine Ball Slam","abdos",0.6,0,0,{abdos:0.7,dos:0.15,epaules:0.15},"medicine ball"],
["db_one_arm_open_palm_kettlebell_clean","One-Arm Open Palm Kettlebell Clean","ischios",1.5,0,0,{ischios:0.7,biceps:0.06,fessiers:0.06,dos:0.06,quads:0.06,epaules:0.06},"kettlebells"],
["db_one_arm_overhead_kettlebell_squats","One-Arm Overhead Kettlebell Squats","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,epaules:0.07},"kettlebells"],
["db_one_arm_side_deadlift","One-Arm Side Deadlift","quads",2.0,0,0,{quads:0.7,abdos:0.05,mollets:0.05,fessiers:0.05,ischios:0.05,dos:0.05,epaules:0.05},"barbell"],
["db_one_arm_side_laterals","One-Arm Side Laterals","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_one_legged_cable_kickback","One-Legged Cable Kickback","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.3},"cable"],
["db_one_arm_against_wall","One Arm Against Wall","dos",1.3,0,0,{dos:1.0},"autre"],
["db_one_arm_chin_up","One Arm Chin-Up","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_one_arm_dumbbell_bench_press","One Arm Dumbbell Bench Press","pecs",1.3,1,0,{pecs:0.7,epaules:0.15,triceps:0.15},"dumbbell"],
["db_one_arm_dumbbell_preacher_curl","One Arm Dumbbell Preacher Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_one_arm_floor_press","One Arm Floor Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"barbell"],
["db_one_arm_lat_pulldown","One Arm Lat Pulldown","dos",1.3,0,0,{dos:0.7,biceps:0.3},"cable"],
["db_one_arm_pronated_dumbbell_triceps_","One Arm Pronated Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_one_arm_supinated_dumbbell_triceps","One Arm Supinated Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_one_half_locust","One Half Locust","quads",2.0,0,0,{quads:0.7,abdos:0.1,biceps:0.1,pecs:0.1},"autre"],
["db_one_handed_hang","One Handed Hang","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_one_knee_to_chest","One Knee To Chest","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.15,dos:0.15},"autre"],
["db_one_leg_barbell_squat","One Leg Barbell Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_open_palm_kettlebell_clean","Open Palm Kettlebell Clean","ischios",1.5,0,0,{ischios:0.7,fessiers:0.07,dos:0.07,quads:0.07,epaules:0.07},"kettlebells"],
["db_otis_up","Otis-Up","abdos",0.6,0,0,{abdos:0.7,pecs:0.1,epaules:0.1,triceps:0.1},"other"],
["db_overhead_cable_curl","Overhead Cable Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_overhead_lat","Overhead Lat","dos",1.3,0,0,{dos:0.7,triceps:0.3},"other"],
["db_overhead_slam","Overhead Slam","dos",1.3,0,0,{dos:1.0},"medicine ball"],
["db_overhead_squat","Overhead Squat","quads",2.0,0,0,{quads:0.7,abdos:0.04,mollets:0.04,fessiers:0.04,ischios:0.04,dos:0.04,epaules:0.04,triceps:0.04},"barbell"],
["db_overhead_stretch","Overhead Stretch","abdos",0.6,0,0,{abdos:0.7,pecs:0.07,biceps:0.07,dos:0.07,triceps:0.07},"autre"],
["db_overhead_triceps","Overhead Triceps","triceps",0.6,0,1,{triceps:0.7,dos:0.3},"body only"],
["db_pallof_press","Pallof Press","abdos",0.6,0,0,{abdos:0.7,pecs:0.1,epaules:0.1,triceps:0.1},"cable"],
["db_pallof_press_with_rotation","Pallof Press With Rotation","abdos",0.6,0,0,{abdos:0.7,pecs:0.1,epaules:0.1,triceps:0.1},"cable"],
["db_palms_down_dumbbell_wrist_curl_ove","Palms-Down Dumbbell Wrist Curl Over A Bench","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_palms_down_wrist_curl_over_a_bench","Palms-Down Wrist Curl Over A Bench","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_palms_up_barbell_wrist_curl_over_a","Palms-Up Barbell Wrist Curl Over A Bench","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_palms_up_dumbbell_wrist_curl_over_","Palms-Up Dumbbell Wrist Curl Over A Bench","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_parallel_bar_dip","Parallel Bar Dip","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"other"],
["db_pelvic_tilt_into_bridge","Pelvic Tilt Into Bridge","dos",1.3,0,0,{dos:1.0},"autre"],
["db_peroneals_smr","Peroneals-SMR","mollets",1.8,0,0,{mollets:1.0},"foam roll"],
["db_peroneals_stretch","Peroneals Stretch","mollets",1.8,0,0,{mollets:1.0},"other"],
["db_physioball_hip_bridge","Physioball Hip Bridge","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.3},"exercise ball"],
["db_pin_presses","Pin Presses","triceps",0.6,0,0,{triceps:0.7,pecs:0.06,biceps:0.06,dos:0.12,epaules:0.06},"barbell"],
["db_piriformis_smr","Piriformis-SMR","fessiers",1.5,0,0,{fessiers:1.0},"foam roll"],
["db_plank","Plank","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_plate_pinch","Plate Pinch","biceps",0.6,0,0,{biceps:1.0},"other"],
["db_plate_twist","Plate Twist","abdos",0.6,0,0,{abdos:1.0},"other"],
["db_platform_hamstring_slides","Platform Hamstring Slides","ischios",1.5,0,0,{ischios:0.7,fessiers:0.3},"other"],
["db_plie_dumbbell_squat","Plie Dumbbell Squat","quads",2.0,1,0,{quads:0.7,abdos:0.07,mollets:0.07,fessiers:0.07,ischios:0.07},"dumbbell"],
["db_plyo_kettlebell_pushups","Plyo Kettlebell Pushups","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"kettlebells"],
["db_plyo_push_up","Plyo Push-up","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_posterior_tibialis_stretch","Posterior Tibialis Stretch","mollets",1.8,0,0,{mollets:1.0},"other"],
["db_power_clean","Power Clean","ischios",1.5,0,0,{ischios:0.7,mollets:0.03,biceps:0.03,fessiers:0.03,dos:0.06,quads:0.03,epaules:0.06,triceps:0.03},"barbell"],
["db_power_clean_from_blocks","Power Clean from Blocks","ischios",1.5,0,0,{ischios:0.7,quads:0.3},"barbell"],
["db_power_jerk","Power Jerk","quads",2.0,0,0,{quads:0.7,abdos:0.05,mollets:0.05,fessiers:0.05,ischios:0.05,epaules:0.05,triceps:0.05},"barbell"],
["db_power_partials","Power Partials","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_power_snatch","Power Snatch","ischios",1.5,0,0,{ischios:0.7,mollets:0.04,fessiers:0.04,dos:0.04,quads:0.04,epaules:0.08,triceps:0.04},"barbell"],
["db_power_snatch_from_blocks","Power Snatch from Blocks","quads",2.0,0,0,{quads:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,ischios:0.04,dos:0.04,epaules:0.08,triceps:0.04},"barbell"],
["db_power_stairs","Power Stairs","ischios",1.5,0,0,{ischios:0.7,fessiers:0.08,mollets:0.04,dos:0.04,quads:0.04,epaules:0.08},"other"],
["db_preacher_curl","Preacher Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_preacher_hammer_dumbbell_curl","Preacher Hammer Dumbbell Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_press_sit_up","Press Sit-Up","abdos",0.6,0,0,{abdos:0.7,pecs:0.1,epaules:0.1,triceps:0.1},"barbell"],
["db_prone_manual_hamstring","Prone Manual Hamstring","ischios",1.5,0,0,{ischios:1.0},"autre"],
["db_prowler_sprint","Prowler Sprint","ischios",1.5,0,0,{ischios:0.7,mollets:0.06,pecs:0.06,fessiers:0.06,quads:0.06,epaules:0.06},"other"],
["db_pull_through","Pull Through","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.15,dos:0.15},"cable"],
["db_pullups","Pullups","dos",1.3,0,1,{dos:0.7,biceps:0.3},"body only"],
["db_push_up_wide","Push-Up Wide","pecs",1.3,0,1,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"body only"],
["db_push_ups_close_triceps_position","Push-Ups - Close Triceps Position","triceps",0.6,0,1,{triceps:0.7,pecs:0.15,epaules:0.15},"body only"],
["db_push_ups_with_feet_elevated","Push-Ups With Feet Elevated","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_push_ups_with_feet_on_an_exercise_","Push-Ups With Feet On An Exercise Ball","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"exercise ball"],
["db_push_press","Push Press","epaules",0.9,0,0,{epaules:0.7,quads:0.15,triceps:0.15},"barbell"],
["db_push_press_behind_the_neck","Push Press - Behind the Neck","epaules",0.9,0,0,{epaules:0.7,mollets:0.1,quads:0.1,triceps:0.1},"barbell"],
["db_push_up_to_side_plank","Push Up to Side Plank","pecs",1.3,0,1,{pecs:0.7,abdos:0.1,epaules:0.1,triceps:0.1},"body only"],
["db_pushups","Pushups","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_pushups_close_and_wide_hand_positi","Pushups (Close and Wide Hand Positions)","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_pyramid","Pyramid","dos",1.3,0,0,{dos:0.7,epaules:0.3},"exercise ball"],
["db_quad_stretch","Quad Stretch","quads",2.0,0,0,{quads:1.0},"other"],
["db_quadriceps_smr","Quadriceps-SMR","quads",2.0,0,0,{quads:1.0},"foam roll"],
["db_quick_leap","Quick Leap","quads",2.0,0,0,{quads:0.7,mollets:0.15,ischios:0.15},"other"],
["db_rack_delivery","Rack Delivery","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"barbell"],
["db_rack_pull_with_bands","Rack Pull with Bands","dos",1.3,0,0,{dos:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,quads:0.06,epaules:0.06},"barbell"],
["db_rack_pulls","Rack Pulls","dos",1.3,0,0,{dos:0.7,biceps:0.07,fessiers:0.07,ischios:0.07,epaules:0.07},"barbell"],
["db_rear_leg_raises","Rear Leg Raises","quads",2.0,0,1,{quads:1.0},"body only"],
["db_recumbent_bike","Recumbent Bike","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_return_push_from_stance","Return Push from Stance","epaules",0.9,0,0,{epaules:0.7,pecs:0.15,triceps:0.15},"medicine ball"],
["db_reverse_band_bench_press","Reverse Band Bench Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.06,biceps:0.06,dos:0.12,epaules:0.06},"barbell"],
["db_reverse_band_box_squat","Reverse Band Box Squat","quads",2.0,0,0,{quads:0.7,fessiers:0.12,mollets:0.04,biceps:0.04,ischios:0.04,dos:0.04},"barbell"],
["db_reverse_band_deadlift","Reverse Band Deadlift","dos",1.3,0,0,{dos:0.7,fessiers:0.15000000000000002,mollets:0.05,ischios:0.05,quads:0.05},"barbell"],
["db_reverse_band_power_squat","Reverse Band Power Squat","quads",2.0,0,0,{quads:0.7,fessiers:0.12,mollets:0.06,ischios:0.06,dos:0.06},"barbell"],
["db_reverse_band_sumo_deadlift","Reverse Band Sumo Deadlift","ischios",1.5,0,0,{ischios:0.7,fessiers:0.12,mollets:0.04,biceps:0.04,dos:0.04,quads:0.04,epaules:0.04},"barbell"],
["db_reverse_barbell_curl","Reverse Barbell Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_reverse_barbell_preacher_curls","Reverse Barbell Preacher Curls","biceps",0.6,0,0,{biceps:1.0},"e-z curl bar"],
["db_reverse_cable_curl","Reverse Cable Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_reverse_crunch","Reverse Crunch","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_reverse_flyes","Reverse Flyes","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_reverse_flyes_with_external_rotati","Reverse Flyes With External Rotation","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_reverse_grip_bent_over_rows","Reverse Grip Bent-Over Rows","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"barbell"],
["db_reverse_grip_triceps_pushdown","Reverse Grip Triceps Pushdown","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_reverse_hyperextension","Reverse Hyperextension","ischios",1.5,0,0,{ischios:0.7,mollets:0.15,fessiers:0.15},"machine"],
["db_reverse_machine_flyes","Reverse Machine Flyes","epaules",0.9,0,0,{epaules:1.0},"machine"],
["db_reverse_plate_curls","Reverse Plate Curls","biceps",0.6,0,0,{biceps:1.0},"other"],
["db_reverse_triceps_bench_press","Reverse Triceps Bench Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"barbell"],
["db_rhomboids_smr","Rhomboids-SMR","dos",1.3,0,0,{dos:0.7,epaules:0.3},"foam roll"],
["db_rickshaw_carry","Rickshaw Carry","biceps",0.6,0,0,{biceps:0.7,abdos:0.04,mollets:0.04,fessiers:0.04,ischios:0.04,dos:0.04,quads:0.04,epaules:0.04},"other"],
["db_rickshaw_deadlift","Rickshaw Deadlift","quads",2.0,0,0,{quads:0.7,biceps:0.06,fessiers:0.06,ischios:0.06,dos:0.06,epaules:0.06},"other"],
["db_ring_dips","Ring Dips","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"other"],
["db_rocket_jump","Rocket Jump","quads",2.0,0,1,{quads:0.7,mollets:0.15,ischios:0.15},"body only"],
["db_rocking_standing_calf_raise","Rocking Standing Calf Raise","mollets",1.8,0,0,{mollets:1.0},"barbell"],
["db_rocky_pull_ups_pulldowns","Rocky Pull-Ups/Pulldowns","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"other"],
["db_romanian_deadlift","Romanian Deadlift","ischios",1.5,0,0,{ischios:0.7,mollets:0.1,fessiers:0.1,dos:0.1},"barbell"],
["db_romanian_deadlift_from_deficit","Romanian Deadlift from Deficit","ischios",1.5,0,0,{ischios:0.7,biceps:0.07,fessiers:0.07,dos:0.07,epaules:0.07},"barbell"],
["db_rope_climb","Rope Climb","dos",1.3,0,0,{dos:0.7,biceps:0.2,epaules:0.1},"other"],
["db_rope_crunch","Rope Crunch","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_rope_jumping","Rope Jumping","quads",2.0,0,0,{quads:0.7,mollets:0.15,ischios:0.15},"other"],
["db_rope_straight_arm_pulldown","Rope Straight-Arm Pulldown","dos",1.3,0,0,{dos:1.0},"cable"],
["db_round_the_world_shoulder_stretch","Round The World Shoulder Stretch","epaules",0.9,0,0,{epaules:0.7,biceps:0.15,pecs:0.15},"other"],
["db_rowing_stationary","Rowing, Stationary","quads",2.0,0,0,{quads:0.7,biceps:0.05,mollets:0.05,fessiers:0.05,ischios:0.05,dos:0.1},"machine"],
["db_runner_s_stretch","Runner's Stretch","ischios",1.5,0,0,{ischios:0.7,mollets:0.3},"autre"],
["db_running_treadmill","Running, Treadmill","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_russian_twist","Russian Twist","abdos",0.6,0,1,{abdos:0.7,dos:0.3},"body only"],
["db_sandbag_load","Sandbag Load","quads",2.0,0,0,{quads:0.7,abdos:0.03,biceps:0.06,mollets:0.03,fessiers:0.03,ischios:0.03,dos:0.06,epaules:0.06},"other"],
["db_scapular_pull_up","Scapular Pull-Up","epaules",0.9,0,0,{epaules:0.7,dos:0.3},"autre"],
["db_scissor_kick","Scissor Kick","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_scissors_jump","Scissors Jump","quads",2.0,0,1,{quads:0.7,fessiers:0.15,ischios:0.15},"body only"],
["db_seated_band_hamstring_curl","Seated Band Hamstring Curl","ischios",1.5,0,0,{ischios:1.0},"other"],
["db_seated_barbell_military_press","Seated Barbell Military Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"barbell"],
["db_seated_barbell_twist","Seated Barbell Twist","abdos",0.6,0,0,{abdos:1.0},"barbell"],
["db_seated_bent_over_one_arm_dumbbell_","Seated Bent-Over One-Arm Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_seated_bent_over_rear_delt_raise","Seated Bent-Over Rear Delt Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_seated_bent_over_two_arm_dumbbell_","Seated Bent-Over Two-Arm Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_seated_biceps","Seated Biceps","biceps",0.6,0,1,{biceps:0.7,pecs:0.15,epaules:0.15},"body only"],
["db_seated_cable_rows","Seated Cable Rows","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_seated_cable_shoulder_press","Seated Cable Shoulder Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"cable"],
["db_seated_calf_raise","Seated Calf Raise","mollets",1.8,0,0,{mollets:1.0},"machine"],
["db_seated_calf_stretch","Seated Calf Stretch","mollets",1.8,0,0,{mollets:0.7,ischios:0.15,dos:0.15},"autre"],
["db_seated_close_grip_concentration_ba","Seated Close-Grip Concentration Barbell Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_seated_dumbbell_curl","Seated Dumbbell Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_seated_dumbbell_inner_biceps_curl","Seated Dumbbell Inner Biceps Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_seated_dumbbell_palms_down_wrist_c","Seated Dumbbell Palms-Down Wrist Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_seated_dumbbell_palms_up_wrist_cur","Seated Dumbbell Palms-Up Wrist Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_seated_dumbbell_press","Seated Dumbbell Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_seated_flat_bench_leg_pull_in","Seated Flat Bench Leg Pull-In","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_seated_floor_hamstring_stretch","Seated Floor Hamstring Stretch","ischios",1.5,0,0,{ischios:0.7,mollets:0.3},"autre"],
["db_seated_front_deltoid","Seated Front Deltoid","epaules",0.9,0,1,{epaules:0.7,pecs:0.3},"body only"],
["db_seated_glute","Seated Glute","fessiers",1.5,0,1,{fessiers:1.0},"body only"],
["db_seated_good_mornings","Seated Good Mornings","dos",1.3,0,0,{dos:0.7,fessiers:0.3},"barbell"],
["db_seated_hamstring","Seated Hamstring","ischios",1.5,0,0,{ischios:0.7,mollets:0.3},"autre"],
["db_seated_hamstring_and_calf_stretch","Seated Hamstring and Calf Stretch","ischios",1.5,0,0,{ischios:0.7,mollets:0.3},"other"],
["db_seated_head_harness_neck_resistanc","Seated Head Harness Neck Resistance","epaules",0.9,0,0,{epaules:1.0},"other"],
["db_seated_leg_curl","Seated Leg Curl","ischios",1.5,0,0,{ischios:1.0},"machine"],
["db_seated_leg_tucks","Seated Leg Tucks","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_seated_one_arm_dumbbell_palms_down","Seated One-Arm Dumbbell Palms-Down Wrist Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_seated_one_arm_dumbbell_palms_up_w","Seated One-Arm Dumbbell Palms-Up Wrist Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_seated_one_arm_cable_pulley_rows","Seated One-arm Cable Pulley Rows","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_seated_overhead_stretch","Seated Overhead Stretch","abdos",0.6,0,0,{abdos:1.0},"autre"],
["db_seated_palm_up_barbell_wrist_curl","Seated Palm-Up Barbell Wrist Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_seated_palms_down_barbell_wrist_cu","Seated Palms-Down Barbell Wrist Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_seated_side_lateral_raise","Seated Side Lateral Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_seated_triceps_press","Seated Triceps Press","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_seated_two_arm_palms_up_low_pulley","Seated Two-Arm Palms-Up Low-Pulley Wrist Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_see_saw_press_alternating_side_pre","See-Saw Press (Alternating Side Press)","epaules",0.9,1,0,{epaules:0.7,abdos:0.15,triceps:0.15},"dumbbell"],
["db_shotgun_row","Shotgun Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"cable"],
["db_shoulder_circles","Shoulder Circles","epaules",0.9,0,0,{epaules:1.0},"autre"],
["db_shoulder_press_with_bands","Shoulder Press - With Bands","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"bands"],
["db_shoulder_raise","Shoulder Raise","epaules",0.9,0,0,{epaules:0.7,dos:0.3},"autre"],
["db_shoulder_stretch","Shoulder Stretch","epaules",0.9,0,0,{epaules:1.0},"autre"],
["db_side_lying_floor_stretch","Side-Lying Floor Stretch","dos",1.3,0,0,{dos:1.0},"autre"],
["db_side_bridge","Side Bridge","abdos",0.6,0,1,{abdos:0.7,epaules:0.3},"body only"],
["db_side_hop_sprint","Side Hop-Sprint","quads",2.0,0,0,{quads:0.7,fessiers:0.14,mollets:0.07,ischios:0.07},"other"],
["db_side_jackknife","Side Jackknife","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_side_lateral_raise","Side Lateral Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_side_laterals_to_front_raise","Side Laterals to Front Raise","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_side_leg_raises","Side Leg Raises","fessiers",1.5,0,1,{fessiers:1.0},"body only"],
["db_side_lying_groin_stretch","Side Lying Groin Stretch","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.3},"autre"],
["db_side_neck_stretch","Side Neck Stretch","epaules",0.9,0,0,{epaules:1.0},"autre"],
["db_side_standing_long_jump","Side Standing Long Jump","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"autre"],
["db_side_to_side_chins","Side To Side Chins","dos",1.3,0,0,{dos:0.7,biceps:0.2,epaules:0.1},"other"],
["db_side_wrist_pull","Side Wrist Pull","epaules",0.9,0,0,{epaules:0.7,biceps:0.15,dos:0.15},"autre"],
["db_side_to_side_box_shuffle","Side to Side Box Shuffle","quads",2.0,0,0,{quads:0.7,fessiers:0.14,mollets:0.07,ischios:0.07},"other"],
["db_single_arm_cable_crossover","Single-Arm Cable Crossover","pecs",1.3,0,0,{pecs:1.0},"cable"],
["db_single_arm_linear_jammer","Single-Arm Linear Jammer","epaules",0.9,0,0,{epaules:0.7,pecs:0.15,triceps:0.15},"barbell"],
["db_single_arm_push_up","Single-Arm Push-Up","pecs",1.3,0,1,{pecs:0.7,epaules:0.15,triceps:0.15},"body only"],
["db_single_cone_sprint_drill","Single-Cone Sprint Drill","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"other"],
["db_single_leg_high_box_squat","Single-Leg High Box Squat","quads",2.0,0,0,{quads:0.7,fessiers:0.15,ischios:0.15},"other"],
["db_single_leg_hop_progression","Single-Leg Hop Progression","quads",2.0,0,0,{quads:0.7,fessiers:0.14,mollets:0.07,ischios:0.07},"other"],
["db_single_leg_lateral_hop","Single-Leg Lateral Hop","quads",2.0,0,0,{quads:0.7,fessiers:0.14,mollets:0.07,ischios:0.07},"other"],
["db_single_leg_leg_extension","Single-Leg Leg Extension","quads",2.0,0,0,{quads:1.0},"machine"],
["db_single_leg_stride_jump","Single-Leg Stride Jump","quads",2.0,0,0,{quads:0.7,fessiers:0.14,mollets:0.07,ischios:0.07},"other"],
["db_single_dumbbell_raise","Single Dumbbell Raise","epaules",0.9,1,0,{epaules:0.7,biceps:0.3},"dumbbell"],
["db_single_leg_butt_kick","Single Leg Butt Kick","quads",2.0,0,1,{quads:0.7,mollets:0.15,ischios:0.15},"body only"],
["db_single_leg_glute_bridge","Single Leg Glute Bridge","fessiers",1.5,0,1,{fessiers:0.7,ischios:0.3},"body only"],
["db_single_leg_push_off","Single Leg Push-off","quads",2.0,0,0,{quads:0.7,mollets:0.15,ischios:0.15},"other"],
["db_sit_up","Sit-Up","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_sit_squats","Sit Squats","quads",2.0,0,0,{quads:0.7,fessiers:0.2,ischios:0.1},"autre"],
["db_skating","Skating","quads",2.0,0,0,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"other"],
["db_sled_drag_harness","Sled Drag - Harness","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"other"],
["db_sled_overhead_backward_walk","Sled Overhead Backward Walk","epaules",0.9,0,0,{epaules:0.7,mollets:0.1,dos:0.1,quads:0.1},"other"],
["db_sled_overhead_triceps_extension","Sled Overhead Triceps Extension","triceps",0.6,0,0,{triceps:1.0},"other"],
["db_sled_push","Sled Push","quads",2.0,0,0,{quads:0.7,mollets:0.06,pecs:0.06,fessiers:0.06,ischios:0.06,triceps:0.06},"other"],
["db_sled_reverse_flye","Sled Reverse Flye","epaules",0.9,0,0,{epaules:1.0},"other"],
["db_sled_row","Sled Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_sledgehammer_swings","Sledgehammer Swings","abdos",0.6,0,0,{abdos:0.7,mollets:0.06,biceps:0.06,dos:0.12,epaules:0.06},"other"],
["db_smith_incline_shoulder_raise","Smith Incline Shoulder Raise","epaules",0.9,0,0,{epaules:0.7,pecs:0.3},"barbell"],
["db_smith_machine_behind_the_back_shru","Smith Machine Behind the Back Shrug","epaules",0.9,0,0,{epaules:1.0},"machine"],
["db_smith_machine_bench_press","Smith Machine Bench Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_smith_machine_bent_over_row","Smith Machine Bent Over Row","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"machine"],
["db_smith_machine_calf_raise","Smith Machine Calf Raise","mollets",1.8,0,0,{mollets:1.0},"machine"],
["db_smith_machine_close_grip_bench_pre","Smith Machine Close-Grip Bench Press","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"machine"],
["db_smith_machine_decline_press","Smith Machine Decline Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_smith_machine_hang_power_clean","Smith Machine Hang Power Clean","ischios",1.5,0,0,{ischios:0.7,fessiers:0.06,dos:0.06,quads:0.06,epaules:0.12},"machine"],
["db_smith_machine_hip_raise","Smith Machine Hip Raise","abdos",0.6,0,0,{abdos:1.0},"machine"],
["db_smith_machine_incline_bench_press","Smith Machine Incline Bench Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"machine"],
["db_smith_machine_leg_press","Smith Machine Leg Press","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_smith_machine_one_arm_upright_row","Smith Machine One-Arm Upright Row","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"machine"],
["db_smith_machine_overhead_shoulder_pr","Smith Machine Overhead Shoulder Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"machine"],
["db_smith_machine_pistol_squat","Smith Machine Pistol Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_smith_machine_reverse_calf_raises","Smith Machine Reverse Calf Raises","mollets",1.8,0,0,{mollets:1.0},"machine"],
["db_smith_machine_squat","Smith Machine Squat","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"machine"],
["db_smith_machine_stiff_legged_deadlif","Smith Machine Stiff-Legged Deadlift","ischios",1.5,0,0,{ischios:0.7,fessiers:0.15,dos:0.15},"machine"],
["db_smith_machine_upright_row","Smith Machine Upright Row","epaules",0.9,0,0,{epaules:0.7,biceps:0.15,dos:0.15},"machine"],
["db_smith_single_leg_split_squat","Smith Single-Leg Split Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_snatch","Snatch","quads",2.0,0,0,{quads:0.7,biceps:0.04,fessiers:0.04,ischios:0.04,dos:0.04,epaules:0.08,triceps:0.04},"barbell"],
["db_snatch_balance","Snatch Balance","quads",2.0,0,0,{quads:0.7,mollets:0.06,fessiers:0.06,ischios:0.06,epaules:0.06,triceps:0.06},"barbell"],
["db_snatch_deadlift","Snatch Deadlift","ischios",1.5,0,0,{ischios:0.7,biceps:0.06,fessiers:0.06,dos:0.06,quads:0.06,epaules:0.06},"barbell"],
["db_snatch_pull","Snatch Pull","ischios",1.5,0,0,{ischios:0.7,mollets:0.06,fessiers:0.06,dos:0.06,quads:0.06,epaules:0.06},"barbell"],
["db_snatch_shrug","Snatch Shrug","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"barbell"],
["db_snatch_from_blocks","Snatch from Blocks","quads",2.0,0,0,{quads:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,ischios:0.04,dos:0.04,epaules:0.08,triceps:0.04},"barbell"],
["db_speed_band_overhead_triceps","Speed Band Overhead Triceps","triceps",0.6,0,0,{triceps:1.0},"bands"],
["db_speed_box_squat","Speed Box Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_speed_squats","Speed Squats","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"barbell"],
["db_spell_caster","Spell Caster","abdos",0.6,1,0,{abdos:0.7,fessiers:0.15,epaules:0.15},"dumbbell"],
["db_spider_crawl","Spider Crawl","abdos",0.6,0,1,{abdos:0.7,pecs:0.1,epaules:0.1,triceps:0.1},"body only"],
["db_spider_curl","Spider Curl","biceps",0.6,0,0,{biceps:1.0},"e-z curl bar"],
["db_spinal_stretch","Spinal Stretch","dos",1.3,0,0,{dos:0.7,epaules:0.3},"autre"],
["db_split_clean","Split Clean","quads",2.0,0,0,{quads:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,ischios:0.04,dos:0.04,epaules:0.08},"barbell"],
["db_split_jerk","Split Jerk","quads",2.0,0,0,{quads:0.7,fessiers:0.07,ischios:0.07,epaules:0.07,triceps:0.07},"barbell"],
["db_split_jump","Split Jump","quads",2.0,0,1,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"body only"],
["db_split_snatch","Split Snatch","ischios",1.5,0,0,{ischios:0.7,mollets:0.04,biceps:0.04,fessiers:0.04,dos:0.04,quads:0.04,epaules:0.08,triceps:0.04},"barbell"],
["db_split_squat_with_dumbbells","Split Squat with Dumbbells","quads",2.0,1,0,{quads:0.7,fessiers:0.15,ischios:0.15},"dumbbell"],
["db_split_squats","Split Squats","ischios",1.5,0,0,{ischios:0.7,mollets:0.1,fessiers:0.1,quads:0.1},"autre"],
["db_squat_jerk","Squat Jerk","quads",2.0,0,0,{quads:0.7,mollets:0.06,fessiers:0.06,ischios:0.06,epaules:0.06,triceps:0.06},"barbell"],
["db_squat_with_bands","Squat with Bands","quads",2.0,0,0,{quads:0.7,fessiers:0.12,mollets:0.06,ischios:0.06,dos:0.06},"barbell"],
["db_squat_with_chains","Squat with Chains","quads",2.0,0,0,{quads:0.7,fessiers:0.12,mollets:0.06,ischios:0.06,dos:0.06},"barbell"],
["db_squat_with_plate_movers","Squat with Plate Movers","quads",2.0,0,0,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"barbell"],
["db_squats_with_bands","Squats - With Bands","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"bands"],
["db_stairmaster","Stairmaster","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_standing_alternating_dumbbell_pres","Standing Alternating Dumbbell Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_standing_barbell_calf_raise","Standing Barbell Calf Raise","mollets",1.8,0,0,{mollets:1.0},"barbell"],
["db_standing_barbell_press_behind_neck","Standing Barbell Press Behind Neck","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"barbell"],
["db_standing_bent_over_one_arm_dumbbel","Standing Bent-Over One-Arm Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:0.7,epaules:0.3},"dumbbell"],
["db_standing_bent_over_two_arm_dumbbel","Standing Bent-Over Two-Arm Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_standing_biceps_cable_curl","Standing Biceps Cable Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_standing_biceps_stretch","Standing Biceps Stretch","biceps",0.6,0,0,{biceps:0.7,pecs:0.15,epaules:0.15},"other"],
["db_standing_bradford_press","Standing Bradford Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"barbell"],
["db_standing_cable_chest_press","Standing Cable Chest Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"cable"],
["db_standing_cable_lift","Standing Cable Lift","abdos",0.6,0,0,{abdos:0.7,epaules:0.3},"cable"],
["db_standing_cable_wood_chop","Standing Cable Wood Chop","abdos",0.6,0,0,{abdos:0.7,epaules:0.3},"cable"],
["db_standing_calf_raises","Standing Calf Raises","mollets",1.8,0,0,{mollets:1.0},"machine"],
["db_standing_concentration_curl","Standing Concentration Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_standing_dumbbell_calf_raise","Standing Dumbbell Calf Raise","mollets",1.8,1,0,{mollets:1.0},"dumbbell"],
["db_standing_dumbbell_press","Standing Dumbbell Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_standing_dumbbell_reverse_curl","Standing Dumbbell Reverse Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_standing_dumbbell_straight_arm_fro","Standing Dumbbell Straight-Arm Front Delt Raise Above Head","epaules",0.9,1,0,{epaules:1.0},"dumbbell"],
["db_standing_dumbbell_triceps_extensio","Standing Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_standing_dumbbell_upright_row","Standing Dumbbell Upright Row","epaules",0.9,1,0,{epaules:0.7,biceps:0.3},"dumbbell"],
["db_standing_elevated_quad_stretch","Standing Elevated Quad Stretch","quads",2.0,0,0,{quads:1.0},"other"],
["db_standing_front_barbell_raise_over_","Standing Front Barbell Raise Over Head","epaules",0.9,0,0,{epaules:1.0},"barbell"],
["db_standing_gastrocnemius_calf_stretc","Standing Gastrocnemius Calf Stretch","mollets",1.8,0,0,{mollets:0.7,ischios:0.3},"autre"],
["db_standing_hamstring_and_calf_stretc","Standing Hamstring and Calf Stretch","ischios",1.5,0,0,{ischios:1.0},"other"],
["db_standing_hip_circles","Standing Hip Circles","fessiers",1.5,0,1,{fessiers:1.0},"body only"],
["db_standing_hip_flexors","Standing Hip Flexors","quads",2.0,0,0,{quads:1.0},"autre"],
["db_standing_inner_biceps_curl","Standing Inner-Biceps Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_standing_lateral_stretch","Standing Lateral Stretch","abdos",0.6,0,0,{abdos:1.0},"autre"],
["db_standing_leg_curl","Standing Leg Curl","ischios",1.5,0,0,{ischios:1.0},"machine"],
["db_standing_long_jump","Standing Long Jump","quads",2.0,0,1,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"body only"],
["db_standing_low_pulley_deltoid_raise","Standing Low-Pulley Deltoid Raise","epaules",0.9,0,0,{epaules:0.7,biceps:0.3},"cable"],
["db_standing_low_pulley_one_arm_tricep","Standing Low-Pulley One-Arm Triceps Extension","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"cable"],
["db_standing_military_press","Standing Military Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"barbell"],
["db_standing_olympic_plate_hand_squeez","Standing Olympic Plate Hand Squeeze","biceps",0.6,0,0,{biceps:1.0},"other"],
["db_standing_one_arm_cable_curl","Standing One-Arm Cable Curl","biceps",0.6,0,0,{biceps:1.0},"cable"],
["db_standing_one_arm_dumbbell_curl_ove","Standing One-Arm Dumbbell Curl Over Incline Bench","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_standing_one_arm_dumbbell_triceps_","Standing One-Arm Dumbbell Triceps Extension","triceps",0.6,1,0,{triceps:0.7,pecs:0.15,epaules:0.15},"dumbbell"],
["db_standing_overhead_barbell_triceps_","Standing Overhead Barbell Triceps Extension","triceps",0.6,0,0,{triceps:0.7,epaules:0.3},"barbell"],
["db_standing_palm_in_one_arm_dumbbell_","Standing Palm-In One-Arm Dumbbell Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_standing_palms_in_dumbbell_press","Standing Palms-In Dumbbell Press","epaules",0.9,1,0,{epaules:0.7,triceps:0.3},"dumbbell"],
["db_standing_palms_up_barbell_behind_t","Standing Palms-Up Barbell Behind The Back Wrist Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_standing_pelvic_tilt","Standing Pelvic Tilt","dos",1.3,0,0,{dos:0.7,fessiers:0.3},"autre"],
["db_standing_rope_crunch","Standing Rope Crunch","abdos",0.6,0,0,{abdos:1.0},"cable"],
["db_standing_soleus_and_achilles_stret","Standing Soleus And Achilles Stretch","mollets",1.8,0,0,{mollets:1.0},"autre"],
["db_standing_toe_touches","Standing Toe Touches","ischios",1.5,0,0,{ischios:0.7,mollets:0.3},"autre"],
["db_standing_towel_triceps_extension","Standing Towel Triceps Extension","triceps",0.6,0,1,{triceps:1.0},"body only"],
["db_standing_two_arm_overhead_throw","Standing Two-Arm Overhead Throw","epaules",0.9,0,0,{epaules:0.7,pecs:0.15,dos:0.15},"medicine ball"],
["db_star_jump","Star Jump","quads",2.0,0,1,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,epaules:0.07},"body only"],
["db_step_up_with_knee_raise","Step-up with Knee Raise","fessiers",1.5,0,1,{fessiers:0.7,ischios:0.15,quads:0.15},"body only"],
["db_step_mill","Step Mill","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_stiff_legged_barbell_deadlift","Stiff-Legged Barbell Deadlift","ischios",1.5,0,0,{ischios:0.7,fessiers:0.15,dos:0.15},"barbell"],
["db_stiff_legged_dumbbell_deadlift","Stiff-Legged Dumbbell Deadlift","ischios",1.5,1,0,{ischios:0.7,fessiers:0.15,dos:0.15},"dumbbell"],
["db_stiff_leg_barbell_good_morning","Stiff Leg Barbell Good Morning","dos",1.3,0,0,{dos:0.7,fessiers:0.15,ischios:0.15},"barbell"],
["db_stomach_vacuum","Stomach Vacuum","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_straight_arm_dumbbell_pullover","Straight-Arm Dumbbell Pullover","pecs",1.3,1,0,{pecs:0.7,dos:0.1,epaules:0.1,triceps:0.1},"dumbbell"],
["db_straight_arm_pulldown","Straight-Arm Pulldown","dos",1.3,0,0,{dos:1.0},"cable"],
["db_straight_bar_bench_mid_rows","Straight Bar Bench Mid Rows","dos",1.3,0,0,{dos:0.7,biceps:0.3},"barbell"],
["db_straight_raises_on_incline_bench","Straight Raises on Incline Bench","epaules",0.9,0,0,{epaules:1.0},"barbell"],
["db_stride_jump_crossover","Stride Jump Crossover","quads",2.0,0,0,{quads:0.7,fessiers:0.14,mollets:0.07,ischios:0.07},"other"],
["db_sumo_deadlift","Sumo Deadlift","ischios",1.5,0,0,{ischios:0.7,fessiers:0.08,biceps:0.04,dos:0.08,quads:0.04,epaules:0.04},"barbell"],
["db_sumo_deadlift_with_bands","Sumo Deadlift with Bands","ischios",1.5,0,0,{ischios:0.7,fessiers:0.08,biceps:0.04,dos:0.08,quads:0.04,epaules:0.04},"barbell"],
["db_sumo_deadlift_with_chains","Sumo Deadlift with Chains","ischios",1.5,0,0,{ischios:0.7,fessiers:0.12,biceps:0.04,dos:0.08,quads:0.04,epaules:0.04},"barbell"],
["db_superman","Superman","dos",1.3,0,1,{dos:0.7,fessiers:0.15,ischios:0.15},"body only"],
["db_supine_chest_throw","Supine Chest Throw","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"medicine ball"],
["db_supine_one_arm_overhead_throw","Supine One-Arm Overhead Throw","abdos",0.6,0,0,{abdos:0.7,pecs:0.1,dos:0.1,epaules:0.1},"medicine ball"],
["db_supine_two_arm_overhead_throw","Supine Two-Arm Overhead Throw","abdos",0.6,0,0,{abdos:0.7,pecs:0.1,dos:0.1,epaules:0.1},"medicine ball"],
["db_suspended_fallout","Suspended Fallout","abdos",0.6,0,0,{abdos:0.7,pecs:0.1,dos:0.1,epaules:0.1},"other"],
["db_suspended_push_up","Suspended Push-Up","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"other"],
["db_suspended_reverse_crunch","Suspended Reverse Crunch","abdos",0.6,0,0,{abdos:1.0},"other"],
["db_suspended_row","Suspended Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_suspended_split_squat","Suspended Split Squat","quads",2.0,0,0,{quads:0.7,fessiers:0.18,mollets:0.06,ischios:0.06},"other"],
["db_svend_press","Svend Press","pecs",1.3,0,0,{pecs:0.7,biceps:0.1,epaules:0.1,triceps:0.1},"other"],
["db_t_bar_row_with_handle","T-Bar Row with Handle","dos",1.3,0,0,{dos:0.7,biceps:0.3},"barbell"],
["db_tate_press","Tate Press","triceps",0.6,1,0,{triceps:0.7,pecs:0.15,epaules:0.15},"dumbbell"],
["db_the_straddle","The Straddle","ischios",1.5,0,0,{ischios:0.7,fessiers:0.15,mollets:0.15},"autre"],
["db_thigh_abductor","Thigh Abductor","fessiers",1.5,0,0,{fessiers:1.0},"machine"],
["db_thigh_adductor","Thigh Adductor","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.3},"machine"],
["db_tire_flip","Tire Flip","quads",2.0,0,0,{quads:0.7,mollets:0.03,pecs:0.03,biceps:0.03,fessiers:0.03,ischios:0.03,dos:0.03,epaules:0.06,triceps:0.03},"other"],
["db_toe_touchers","Toe Touchers","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_torso_rotation","Torso Rotation","abdos",0.6,0,0,{abdos:1.0},"exercise ball"],
["db_trail_running_walking","Trail Running/Walking","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"autre"],
["db_trap_bar_deadlift","Trap Bar Deadlift","quads",2.0,0,0,{quads:0.7,fessiers:0.15,ischios:0.15},"other"],
["db_tricep_dumbbell_kickback","Tricep Dumbbell Kickback","triceps",0.6,1,0,{triceps:1.0},"dumbbell"],
["db_tricep_side_stretch","Tricep Side Stretch","triceps",0.6,0,0,{triceps:0.7,epaules:0.3},"autre"],
["db_triceps_overhead_extension_with_ro","Triceps Overhead Extension with Rope","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_triceps_pushdown","Triceps Pushdown","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_triceps_pushdown_rope_attachment","Triceps Pushdown - Rope Attachment","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_triceps_pushdown_v_bar_attachment","Triceps Pushdown - V-Bar Attachment","triceps",0.6,0,0,{triceps:1.0},"cable"],
["db_triceps_stretch","Triceps Stretch","triceps",0.6,0,0,{triceps:0.7,dos:0.3},"autre"],
["db_tuck_crunch","Tuck Crunch","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_two_arm_dumbbell_preacher_curl","Two-Arm Dumbbell Preacher Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_two_arm_kettlebell_clean","Two-Arm Kettlebell Clean","epaules",0.9,0,0,{epaules:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"kettlebells"],
["db_two_arm_kettlebell_jerk","Two-Arm Kettlebell Jerk","epaules",0.9,0,0,{epaules:0.7,mollets:0.1,quads:0.1,triceps:0.1},"kettlebells"],
["db_two_arm_kettlebell_military_press","Two-Arm Kettlebell Military Press","epaules",0.9,0,0,{epaules:0.7,triceps:0.3},"kettlebells"],
["db_two_arm_kettlebell_row","Two-Arm Kettlebell Row","dos",1.3,0,0,{dos:0.7,biceps:0.3},"kettlebells"],
["db_underhand_cable_pulldowns","Underhand Cable Pulldowns","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_upper_back_leg_grab","Upper Back-Leg Grab","ischios",1.5,0,0,{ischios:0.7,dos:0.3},"autre"],
["db_upper_back_stretch","Upper Back Stretch","dos",1.3,0,0,{dos:1.0},"autre"],
["db_upright_barbell_row","Upright Barbell Row","epaules",0.9,0,0,{epaules:1.0},"barbell"],
["db_upright_cable_row","Upright Cable Row","epaules",0.9,0,0,{epaules:1.0},"cable"],
["db_upright_row_with_bands","Upright Row - With Bands","epaules",0.9,0,0,{epaules:1.0},"bands"],
["db_upward_stretch","Upward Stretch","epaules",0.9,0,0,{epaules:0.7,pecs:0.15,dos:0.15},"autre"],
["db_v_bar_pulldown","V-Bar Pulldown","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_v_bar_pullup","V-Bar Pullup","dos",1.3,0,1,{dos:0.7,biceps:0.15,epaules:0.15},"body only"],
["db_vertical_swing","Vertical Swing","ischios",1.5,1,0,{ischios:0.7,fessiers:0.1,quads:0.1,epaules:0.1},"dumbbell"],
["db_walking_treadmill","Walking, Treadmill","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"machine"],
["db_weighted_ball_hyperextension","Weighted Ball Hyperextension","dos",1.3,0,0,{dos:0.7,fessiers:0.15,ischios:0.15},"exercise ball"],
["db_weighted_ball_side_bend","Weighted Ball Side Bend","abdos",0.6,0,0,{abdos:1.0},"exercise ball"],
["db_weighted_bench_dip","Weighted Bench Dip","triceps",0.6,0,0,{triceps:0.7,pecs:0.15,epaules:0.15},"other"],
["db_weighted_crunches","Weighted Crunches","abdos",0.6,0,0,{abdos:1.0},"medicine ball"],
["db_weighted_jump_squat","Weighted Jump Squat","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"barbell"],
["db_weighted_pull_ups","Weighted Pull Ups","dos",1.3,0,0,{dos:0.7,biceps:0.3},"other"],
["db_weighted_sissy_squat","Weighted Sissy Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_weighted_sit_ups_with_bands","Weighted Sit-Ups - With Bands","abdos",0.6,0,0,{abdos:1.0},"other"],
["db_weighted_squat","Weighted Squat","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"other"],
["db_wide_grip_barbell_bench_press","Wide-Grip Barbell Bench Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_wide_grip_decline_barbell_bench_pr","Wide-Grip Decline Barbell Bench Press","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_wide_grip_decline_barbell_pullover","Wide-Grip Decline Barbell Pullover","pecs",1.3,0,0,{pecs:0.7,epaules:0.15,triceps:0.15},"barbell"],
["db_wide_grip_lat_pulldown","Wide-Grip Lat Pulldown","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_wide_grip_pulldown_behind_the_neck","Wide-Grip Pulldown Behind The Neck","dos",1.3,0,0,{dos:0.7,biceps:0.15,epaules:0.15},"cable"],
["db_wide_grip_rear_pull_up","Wide-Grip Rear Pull-Up","dos",1.3,0,1,{dos:0.7,biceps:0.15,epaules:0.15},"body only"],
["db_wide_grip_standing_barbell_curl","Wide-Grip Standing Barbell Curl","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_wide_stance_barbell_squat","Wide Stance Barbell Squat","quads",2.0,0,0,{quads:0.7,mollets:0.07,fessiers:0.07,ischios:0.07,dos:0.07},"barbell"],
["db_wide_stance_stiff_legs","Wide Stance Stiff Legs","ischios",1.5,0,0,{ischios:0.7,fessiers:0.2,dos:0.1},"barbell"],
["db_wind_sprints","Wind Sprints","abdos",0.6,0,1,{abdos:1.0},"body only"],
["db_windmills","Windmills","fessiers",1.5,0,0,{fessiers:0.7,ischios:0.15,dos:0.15},"autre"],
["db_world_s_greatest_stretch","World's Greatest Stretch","ischios",1.5,0,0,{ischios:0.7,mollets:0.1,fessiers:0.1,quads:0.1},"autre"],
["db_wrist_circles","Wrist Circles","biceps",0.6,0,1,{biceps:1.0},"body only"],
["db_wrist_roller","Wrist Roller","biceps",0.6,0,0,{biceps:0.7,epaules:0.3},"other"],
["db_wrist_rotations_with_straight_bar","Wrist Rotations with Straight Bar","biceps",0.6,0,0,{biceps:1.0},"barbell"],
["db_yoke_walk","Yoke Walk","quads",2.0,0,0,{quads:0.7,abdos:0.04,fessiers:0.12,mollets:0.04,ischios:0.04,dos:0.04},"other"],
["db_zercher_squats","Zercher Squats","quads",2.0,0,0,{quads:0.7,mollets:0.1,fessiers:0.1,ischios:0.1},"barbell"],
["db_zottman_curl","Zottman Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
["db_zottman_preacher_curl","Zottman Preacher Curl","biceps",0.6,1,0,{biceps:1.0},"dumbbell"],
];
    ...
    <div style={S.app}>
      ...
      <main style={S.main}>
        ...
        {tab === "seances" && (editingRoutine
          ...
          : <SeancesHub sub={seancesSub} setSub={setSeancesSub} routines={routines}
...
/* --------------------------- PARAMÈTRES ------------------------------ */
function Settings({ profile, setProfile, dataTabProps, onResetOnboarding }) {
...
/* ----------------------------- PROFIL (hub) -------------------------- */
function Profil({ sub, setSub, overall, muscleScores, loggedCount, history, cardio, levelInfo, totalXp, xpNow, bw, profile, setProfile, lifts, prs, dataTabProps, onResetOnboarding, flash }) {
  ...
  return (
    <div style={{ display: "grid", gap: 14 }}>
      ...
      {sub === "parametres" && <Settings profile={profile} setProfile={setProfile} dataTabProps={dataTabProps} onResetOnboarding={onResetOnboarding} />}
    </div>
  );
}

/* --------------------------- SÉANCES (hub) --------------------------- */
function SeancesHub({ sub, setSub, routines, onNew, onEdit, onDelete, onStart, onExport, onAddPreset, cardio, bw, onAddCardio, onClearCardio }) {
  ...
  return (
    <div style={{ display: "grid", gap: 14 }}>
      ...
      {sub === "base" && <Seances routines={routines} onNew={onNew} onEdit={onEdit} onDelete={onDelete} onStart={onStart} onExport={onExport} onAddPreset={onAddPreset} />}
      ...
      <div key={ex.key} style={S.exoInner}>
        <div onClick={() => setOpenExo(isOpen ? null : ex.key)} style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }}>
          ...
          <div style={{ flex: 1 }}><div style={{ fontWeight: 700, fontSize: 14 }}>{ex.name}{ex.perHand ? <span style={{ fontSize: 11, opacity: 0.5, fontWeight: 500 }}> /main</span> : null}</div>
            <div style={{ fontSize: 12, opacity: 0.55 }}>{rec?.best1RM ? (ex.isTime ? `Record : ${rec.best1RM}s` : `1RM estimé : ${rec.best1RM} kg`) : (ex.equipment ? ex.equipment : "Aucune donnée")}{prs[ex.key] ? ` · PR ${prs[ex.key]}kg` : ""}</div></div>
